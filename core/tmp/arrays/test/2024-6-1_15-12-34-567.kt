...
fun box(): (@UseExperimental(Annotation::class, Annotation::class)
String)? {
    return "pfwxj"
}
...
//File being compiled: /home/Anzhela.Sukhanova/fuzzer/JVMCompiler/projectTmp/capturedStarProjection.kt
...
//Caused by: java.lang.IllegalStateException: Unresolved annotation type: [Error type: Unresolved type for UseExperimental] at /home/Anzhela.Sukhanova/fuzzer/JVMCompiler/projectTmp/capturedStarProjection.kt
...
//	at org.jetbrains.kotlin.serialization.DescriptorSerializer.packagePartProto(DescriptorSerializer.kt:746)
//	at org.jetbrains.kotlin.backend.jvm.metadata.DescriptorMetadataSerializer.serialize(DescriptorMetadataSerializer.kt:74)
