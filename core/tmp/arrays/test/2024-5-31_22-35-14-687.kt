...
inline fun <return> bar(expected: KType) {
    assertEquals(expected as KType, foo<List<@UnsafeVariance()
T>>())
...
fun box(): String {
    ...
    return (box()).plus("cuqxq")
}



//Combined output:
//org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (19,5) in /home/Anzhela.Sukhanova/fuzzer/JVMCompiler/projectTmp/reifiedAsNestedArgument.kt
//
//Attachments:
//causeThrowable
...
//----
//expression.kt
//File name: reifiedAsNestedArgument.kt Physical: true Injected: false
//fun box(): String {
//    <caret>bar<Int>(typeOf<List<Int>>())
//    return (box()).plus("cuqxq")
//}
