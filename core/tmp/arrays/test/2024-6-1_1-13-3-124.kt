...
fun <return> foo(iFoo: IFoo<T>) = iFoo.foo()
...
//Combined output:
//org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (18,5) in /home/Anzhela.Sukhanova/fuzzer/JVMCompiler/projectTmp/voidReturnTypeAsGeneric.kt
//
//Attachments:
//causeThrowable
...
//----
//expression.kt
//File name: voidReturnTypeAsGeneric.kt Physical: true Injected: false
//fun box(): String {
//    <caret>foo { ok = "OK" }
//    T ok
//}
