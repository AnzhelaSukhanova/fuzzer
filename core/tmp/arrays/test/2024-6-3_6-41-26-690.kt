...
inline fun <.> useRef(value: T, f: (T) -> Boolean) = f(value)
...
//Combined output:
//org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (11,16) in /home/Anzhela.Sukhanova/fuzzer/JVMCompiler/projectTmp/kt49526.kt
//
//Attachments:
//causeThrowable
...
//----
//expression.kt
//File name: kt49526.kt Physical: true Injected: false
//fun box(): String {
//    val chars = listOf('a') + "-"
//    return if (<caret>useRef('a', chars::contains!!)) "OK" else "Failed"
//}
