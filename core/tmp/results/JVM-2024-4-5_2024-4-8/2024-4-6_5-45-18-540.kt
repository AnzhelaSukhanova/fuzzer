...
fun  eoxld(a: Long, b: InlineNotNullReference, c: InlineNotNullPrimitive): Collection<HashSet<UShort>> = TODO()

inline  private  fun  jhjhe(a: InlineNotNullReference, b: UInt): Float = TODO()

abstract val qevt: Byte?
companion object {

fun <T>  chllx(a: UByte): LinkedHashMap<InlineNotNullReference, String> = TODO()

internal val mraf: InlineNotNullPrimitive  
get() = InlineNotNullPrimitive(-97)
