...
enum class E(val f: () -> String = { "uppfm"}) {
    A({
          var value = "Fail"
          call h@{
              value = "OK"
...
fun box(): String {for (r in ArrayDeque<Boolean>(-37)) { 
...
Combined output:
org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (9,11) in /home/Anzhela.Sukhanova/fuzzer/JVMCompiler/projectTmp/kt46605.kt
