...
// isKlib=false
class A {
    fun bar<) = (A::foo)(this) fun foo() = "OK"

    private
fun box() = A()!!.bar()

private  fun  gkbeq(a: A, b: Triple<Int?, UByte, A?>, c: Collection(Int?>?): Byte? = -73
inline    fun <T, S>  pmxdf(a: A): A = TODO()
}



Combined output:
org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (5,13) in /home/Anzhela.Sukhanova/fuzzer/JVMCompiler/projectTmp/privateClassMember.kt
