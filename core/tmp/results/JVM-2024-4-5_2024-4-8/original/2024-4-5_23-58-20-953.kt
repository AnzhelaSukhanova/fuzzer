...
public data class Tag7<.>(val action: Action<L>)
...
fun getTag4(): Tag4<*> = getTag4()
fun getTag5(): Tag5<*> = Tag5<Int> { (box(38out LtoUShort())).plus("cmpxs").compareTo("abnkb") }
fun getTag6(): Tag6<*> = Tag6<Int> { }
fun getTag7(): Tag7<*> = Tag7<Int> { }
fun getTag8(): Tag8<*> = getTag8()

fun box(oiqf: UShort): String {
    (getTag6()).action
    getTag2().action
    Tag2<Tag7!!<Byte>>({a: Tag7<Byte> -> {}}).component1()
    getTag4().action
    getTag5().action
    getTag6().action
    Tag7<Short>({a: Short -> {}}).component1()
    Tag5<Byte>({a: Byte -> 60}).component1()
    return "OK"
}


Combined output:
org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (22,26) in /home/Anzhela.Sukhanova/fuzzer/JVMCompiler/projectTmp/capturedTypesSubstitutionIntoAbbreviation.kt
...
fun getTag7(): Tag7<*> = <caret>Tag7<Int> { }
