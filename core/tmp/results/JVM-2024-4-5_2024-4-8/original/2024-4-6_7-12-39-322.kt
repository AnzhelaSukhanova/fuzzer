...
inline fun crossInlineBuildWrapper(crossinline block: @UnsafeVariance()
() -> Unit) = object : Wrapper {
    override fun runBlock() {
        block()
    }
external internal  fun  wwdub(a: Wrapper): HashMap<ArrayDeque<UInt?>, Wrapper?>
} as Set<(UByte)> as Wrapper
  ...
  BLOCK_BODY
    ...
    BLOCK type=kotlin.Unit origin=null
      SET_FIELD 'FIELD PROPERTY_BACKING_FIELD name:wrapper type:<root>.Wrapper visibility:private [final]' type=kotlin.Unit origin=INITIALIZE_FIELD
        ...
        value: CALL 'public final fun crossInlineBuildWrapper (block: @[UnsafeVariance] kotlin.Function0<kotlin.Unit>): <root>.Wrapper [inline] declared in <root>.CrossinlineLocalDeclarationKt' type=<root>.Wrapper origin=null
	...
	... 24 more
Caused by: org.jetbrains.kotlin.codegen.CompilationException: Back-end (JVM) Internal error: Couldn't inline method call: CALL 'public final fun crossInlineBuildWrapper (block: @[UnsafeVariance] kotlin.Function0<kotlin.Unit>): <root>.Wrapper [inline] declared in <root>.CrossinlineLocalDeclarationKt' type=<root>.Wrapper origin=null
File is unknown
...
Cause: wwdub$main (LWrapper;Lkotlin/jvm/functions/Function0;)Ljava/util/HashMap;:
