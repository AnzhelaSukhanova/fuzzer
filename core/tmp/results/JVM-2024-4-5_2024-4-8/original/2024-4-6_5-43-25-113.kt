...
public open class Agi <out T>  (var zbq: String, val mri: UInt, var ajd: T, val hvv: Function1<Elx, Elx>){


public  fun  hovgy(a: out T, b: Char, c: Long?): InlineNotNullPrimitive = TODO()

internal val inyk: Float  
get() = TODO()


private var fkts: Double  
get() = @Suppress("fywtv", "advbo", "ztiqm")
TODO()
set(value) = TODO()


internal var nwex: T  = TODO()
companion object {

fun  zlmqj(a: List<Boolean>): Triple<Elx, InlineNotNullReference?, LinkedHashSet<UShort?>> = TODO()

external internal  fun <T: AbstractCoroutineContextElement>  ulqtt(a: ArrayDeque<Function1<UShort, InlineNotNullReference>>, b: T): Boolean

private var dqap: Collection<Elx>  
get() = TODO()
set(value) = TODO()


public var gzzm: Boolean  = false

public var qsrh: Boolean  
get() = false
set(value) = TODO()
...
inline class InlineNotNullPrimitive@ExperimentalMultiplatform()
(val x: Int)
