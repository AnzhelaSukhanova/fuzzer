...
fun box(zjvn: Byte?  = -89) : String {
    val ai = A<Int>((box(36)).compareTo(box(-50)))
    val aai = A<A<Int>>(ai)
...
Combined output:
org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (10,14) in /home/Anzhela.Sukhanova/fuzzer/JVMCompiler/projectTmp/kt257.kt
...
fun box(zjvn: Byte?  = -89) : String {
    val ai = <caret>A<Int>((box(36)).compareTo(box(-50)))
    val aai = A<A<Int>>(ai)
    if((ai).t != 1)  return "fail"
/*
    aai.t.t = 2
