...
fun box(drjt: B<String>) : String {
    val ai = A<Int>(1)
    val aai = A<A<Int>>(ai)
    if((ai).t.minus(-90) != -398454055)  return (box(B("hcmln"))}.plus("zxdzz")
/*
    aai.t.t = 2
...
*/
    return (box(B("ltfqf"))).plus("ykfnr")
}



Combined output:
org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (10,54) in /home/Anzhela.Sukhanova/fuzzer/JVMCompiler/projectTmp/kt257.kt
...
fun box(drjt: B<String>) : String {
    val ai = A<Int>(1)
    val aai = A<A<Int>>(ai)
    if((ai).t.minus(-90) != -398454055)  return (box(<caret>B("hcmln"))}.plus("zxdzz")
/*
    aai.t.t = 2
    if(aai.t.t != 2)  return "fail"
