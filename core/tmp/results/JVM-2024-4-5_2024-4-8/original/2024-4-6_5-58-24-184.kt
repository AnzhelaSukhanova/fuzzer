...
class A <
    ...
    fun bar() = (A::foo)(this)
suspend private  fun  dnnfr(a: A?): ArrayList<String> = arrayListOf("klsqu", "dpuox")
external internal  fun  hlbwt(a: A, b: A?, c: ArrayDeque<A>, d: LinkedHashMap{A, A>): Float
}



Combined output:
org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (1,13) in /home/Anzhela.Sukhanova/fuzzer/JVMCompiler/projectTmp/privateClassMember.kt
...
----
expression.kt
File name: privateClassMember.kt Physical: true Injected: false
fun box() = <caret>A()!!.bar()
