...
import kotlin.jvm.*
data internal  class Rhs  (val sdc: InlineNotNullPrimitive?, val wvy: Array<Int>){
...
fun <T> testNotNullPrimitive(a: Any, b: @JvmWildcard()
T, c: InlineNotNullPrimitive, d: InlineNotNullPrimitive?) {}
