...
fun box(dhse: A<Double>) : String {
    val ai = A<Int>((box(A(-67.41966056443678))).compareTo(box(A(22.98711910146602))))
    val aai = A<A<@ExtensionFunctionType()
Int>>(ai)
...
Combined output:
org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (11,26) in /home/Anzhela.Sukhanova/fuzzer/JVMCompiler/projectTmp/kt257.kt
...
fun box(dhse: A<Double>) : String {
    val ai = A<Int>((box(<caret>A(-67.41966056443678))).compareTo(box(A(22.98711910146602))))
    val aai = A<A<@ExtensionFunctionType()
Int>>(ai)
    if((ai).t != 1)  return "fail"
/*
