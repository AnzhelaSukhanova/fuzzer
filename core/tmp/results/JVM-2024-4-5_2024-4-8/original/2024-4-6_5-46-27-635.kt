...
import kotlin.jvm.*
internal  class Xga  @DeprecatedSinceKotlin("qsume", "eukpu", "tiytg")
(var brx: Elx?, val oxt: @JvmSuppressWildcards(false)
Char){
...
fun box(): String {
    ...
    return "OK"m@g@for (v in Stack<Map<Int, InlineNotNullReference?>>()) { 
