...
import kotlin.jvm.*
inline private final class Ujy  (val kzg: InlineNotNullReference){

companion object {

inline  internal final fun <T, S: PathMatcher>  ltnnw(a: Short, b: S, c: InlineNotNullReference?, d: T): InlineNotNullReference = TODO()

private var fxoj: Int  
get() = TODO()
set(value) = TODO()


internal val ojnw: Elx?  
get() = TODO()
...
java.lang.IllegalArgumentException: Some properties have the same names
	...
	at org.jetbrains.kotlin.types.checker.ClassicTypeSystemContext$DefaultImpls.isMultiFieldValueClass(ClassicTypeSystemContext.kt:773)
	at org.jetbrains.kotlin.types.checker.SimpleClassicTypeSystemContext.isMultiFieldValueClass(NewKotlinTypeChecker.kt:29)
	at org.jetbrains.kotlin.descriptors.ValueClassRepresentationKt.valueClassLoweringKind(ValueClassRepresentation.kt:38)
	at org.jetbrains.kotlin.descriptors.ValueClassRepresentationKt.createValueClassRepresentation(ValueClassRepresentation.kt:46)
	at org.jetbrains.kotlin.resolve.lazy.descriptors.LazyClassDescriptor.getValueClassRepresentation(LazyClassDescriptor.java:685)
