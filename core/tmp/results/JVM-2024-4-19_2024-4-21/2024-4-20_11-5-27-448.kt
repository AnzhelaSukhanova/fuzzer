...
val <T : KClass<E : Any>> T.myjava1: Class<*>
    get() = java

val <*, T : KClass<E>> T.myjava2: Class<E>
    get() = java

class O{
infix internal  fun   String?.jxpiq(a: O?): String = TODO()
external  final fun  lyjzl(a: ArrayList<HashSet<K>>, b: Float): K
inline  protected  fun  yewxa(a: UInt, b: Short): String? = TODO()
}
class K
...
//Combined output:
//org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (24,44) in /home/Anzhela.Sukhanova/fuzzer/JVMCompiler/projectTmp/kt11943.kt
//
//Attachments:
//causeThrowable
