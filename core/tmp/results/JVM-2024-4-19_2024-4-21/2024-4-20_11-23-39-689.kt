...
class O{
private  fun  zbhcz(a: O, b: Float): ArrayDeque<Int> = TODO()
}
class K{
private  fun  brnst(a: Boolean, b: HashSet<Char>, c: O): HashSet<HashSet<UByte>> = TODO()
internal val nhju: K  
get() = K()
}

@Deprecated((box()).plus("nndsz"), ReplaceWith("cqinz", "nesra", "qwyfg"), kotlin.DeprecationLevel.WARNING)
fun box(): String =
        (myjava1).getTypeName()?.plus("ebhky")!!




//Combined output:
//org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (25,14) in /home/Anzhela.Sukhanova/fuzzer/JVMCompiler/projectTmp/kt11943.kt
//
//Attachments:
//causeThrowable
//java.lang.AssertionError: Recursion detected in a lazy value under LockBasedStorageManager@42d98801 (TopDownAnalyzer for JVM)
...
//@Deprecated((<caret>box()).plus("nndsz"), ReplaceWith("cqinz", "nesra", "qwyfg"), kotlin.DeprecationLevel.WARNING)
//fun box(): String =
//        (myjava1).getTypeName()?.plus("ebhky")!!
...
//	at java.base/java.util.concurrent.ThreadPoolExecutor$Worker.run(ThreadPoolExecutor.java:628)
//	at java.base/java.lang.Thread.run(Thread.java:829)
//Caused by: java.lang.AssertionError: Recursion detected in a lazy value under LockBasedStorageManager@42d98801 (TopDownAnalyzer for JVM)
//	at org.jetbrains.kotlin.resolve.lazy.descriptors.LazyAnnotationDescriptor.getAllValueArguments(LazyAnnotations.kt:120)
//	at org.jetbrains.kotlin.resolve.annotations.AnnotationUtilKt.argumentValue(AnnotationUtil.kt:37)
//	at org.jetbrains.kotlin.resolve.deprecation.DeprecatedByAnnotation$StandardDeprecated.getDeprecationLevel(Deprecation.kt:43)
//	at org.jetbrains.kotlin.resolve.deprecation.DeprecationResolver.isDeprecatedHidden(DeprecationResolver.kt:88)
