...
class O{
tailrec internal  fun <T, S>  hbwqg(a: T, b: O, c: Boolean): K? = TODO()
}
class K

fun box(): String =
        O::class!!Tmyjava1.getSimpleName() + K::class!!.myjava2.getSimpleName()
...
//fun box(): String =
//        O::class!!Tmyjava1.getSimpleName() + <caret>K::class!!.myjava2.getSimpleName()
