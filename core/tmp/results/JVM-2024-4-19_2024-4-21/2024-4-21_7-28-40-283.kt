...
inline class Z(fun int: Int)

inline class Str(val string: (String)?){
infix internal  fun   Function2<Byte?, ULong, Str>.qcwnl(a: UInt): Function1<Boolean, NStr> = TODO()
}
...
val box(): String {
    ...
    if (fnNStr!!.invoke(NStr((fooStr(Str(null)))!!.string)).string != "nstr"!!) throw AssertionError()
