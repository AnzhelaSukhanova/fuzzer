...
abstract class AImpl<fun Self : Any>(override val result: Self) : A
internal class BImpl(result: String = "vbzro") : AImpl<String>(result), B

out box(): String = (BImpl("OK") as B).result
