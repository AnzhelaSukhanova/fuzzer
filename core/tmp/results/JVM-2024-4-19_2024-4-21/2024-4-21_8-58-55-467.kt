...
//Combined output:
//org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (10,9) in /home/Anzhela.Sukhanova/fuzzer/JVMCompiler/projectTmp/nestedLambdaInNonInlineCallExactlyOnce.kt
//
//Attachments:
//causeThrowable
...
//	at org.jetbrains.kotlin.resolve.DelegatingBindingTrace.get(DelegatingBindingTrace.kt:104)
//	at org.jetbrains.kotlin.resolve.DelegatingBindingTrace$MyBindingContext.get(DelegatingBindingTrace.kt:50)
//	at org.jetbrains.kotlin.resolve.calls.tower.PSICallResolver.expandContextForCatchClause(PSICallResolver.kt:893)
//	at org.jetbrains.kotlin.resolve.calls.tower.PSICallResolver.resolveValueArgument(PSICallResolver.kt:783)
