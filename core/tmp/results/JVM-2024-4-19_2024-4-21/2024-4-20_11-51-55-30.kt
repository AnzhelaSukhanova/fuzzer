...
internal final fun  epiop(a: Function2<UByte, UInt, List<Double>>, b: Float?): Byte? = TODO()
    ...
    fun test() = Array<B> (10, { B(((box()).compareTo("nuhmu")).compareTo(84.34656303398029)) })
}

@Deprecated("ntyhp", ReplaceWith((A().test()).toString(), "ecjkl", "olywi", "rezad"), kotlin.DeprecationLevel.WARNING)
fun box() = if((box()).compareTo("ivtfj") == (A.B(-(box()).length.div(81))).i) (A().test()).toString() else "fail"



//Combined output:
//org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (7,38) in /home/Anzhela.Sukhanova/fuzzer/JVMCompiler/projectTmp/nonNullArray.kt
//
//Attachments:
//causeThrowable
//java.lang.AssertionError: Recursion detected in a lazy value under LockBasedStorageManager@3c8007ab (TopDownAnalyzer for JVM)
...
//}
//
//    fun test() = Array<B> (10, { B(((<caret>box()).compareTo("nuhmu")).compareTo(84.34656303398029)) })
//}
...
//	at java.base/java.util.concurrent.ThreadPoolExecutor$Worker.run(ThreadPoolExecutor.java:628)
//	at java.base/java.lang.Thread.run(Thread.java:829)
//Caused by: java.lang.AssertionError: Recursion detected in a lazy value under LockBasedStorageManager@3c8007ab (TopDownAnalyzer for JVM)
//	at org.jetbrains.kotlin.resolve.lazy.descriptors.LazyAnnotationDescriptor.getAllValueArguments(LazyAnnotations.kt:120)
//	at org.jetbrains.kotlin.resolve.annotations.AnnotationUtilKt.argumentValue(AnnotationUtil.kt:37)
//	at org.jetbrains.kotlin.resolve.deprecation.DeprecatedByAnnotation$StandardDeprecated.getDeprecationLevel(Deprecation.kt:43)
//	at org.jetbrains.kotlin.resolve.deprecation.DeprecationResolver.isDeprecatedHidden(DeprecationResolver.kt:88)
