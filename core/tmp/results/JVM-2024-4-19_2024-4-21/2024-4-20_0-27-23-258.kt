...
private final class Whx  (var ctr: InlineNullablePrimitive, var gew: Long, val qwg: Float, var vgd: Array<String> = Array<String>(96, {a: Int -> "kmeix"}), vararg wrn: Short){


public  fun  ubfbe(a: Byte, b: Double): HashMap<InlineNotNullPrimitive?, InlineNullableReference> = TODO()

inline infix public  fun   Array<LinkedHashSet<List<String?>>>.xodon(a: UByte): String = TODO()

public val jnnt: Function2<InlineNotNullReference, Long, UShort>  
get() = TODO()
...
inline class InlineNotNullReference(val (c: InlineNotNullReference): Any)
inline class InlineNullableReference(val a: Any?)

fun test1(a: InlineNotNullPrimitive) {o@for (i in LongRange(7, 72)) { 
 val a0 = a
val a1: Any = a // box
val a2: Any? = a // box
}
...
fun test4(d: InlineNullableReference) {
    ...
    val d1: Any = d // box
    val d2: Any? = d // box
    test2(InlineNullablePrimitive(4))
