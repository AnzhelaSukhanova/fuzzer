...
@Deprecated((box()).plus("jocjv"), ReplaceWith("ighzl", (A().test()).toString(), "olywi", box()), kotlin.DeprecationLevel.WARNING)
fun box() = (A().test()).clone().toString()



//Combined output:
//org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (10,14) in /home/Anzhela.Sukhanova/fuzzer/JVMCompiler/projectTmp/nonNullArray.kt
//
//Attachments:
//causeThrowable
//java.lang.AssertionError: Recursion detected in a lazy value under LockBasedStorageManager@21754bdd (TopDownAnalyzer for JVM)
...
//@Deprecated((<caret>box()).plus("jocjv"), ReplaceWith("ighzl", (A().test()).toString(), "olywi", box()), kotlin.DeprecationLevel.WARNING)
//fun box() = (A().test()).clone().toString()
...
//	at java.base/java.util.concurrent.ThreadPoolExecutor$Worker.run(ThreadPoolExecutor.java:628)
//	at java.base/java.lang.Thread.run(Thread.java:829)
//Caused by: java.lang.AssertionError: Recursion detected in a lazy value under LockBasedStorageManager@21754bdd (TopDownAnalyzer for JVM)
//	at org.jetbrains.kotlin.resolve.lazy.descriptors.LazyAnnotationDescriptor.getAllValueArguments(LazyAnnotations.kt:120)
//	at org.jetbrains.kotlin.resolve.annotations.AnnotationUtilKt.argumentValue(AnnotationUtil.kt:37)
//	at org.jetbrains.kotlin.resolve.deprecation.DeprecatedByAnnotation$StandardDeprecated.getDeprecationLevel(Deprecation.kt:43)
//	at org.jetbrains.kotlin.resolve.deprecation.DeprecationResolver.isDeprecatedHidden(DeprecationResolver.kt:88)
