...
suspend public  fun  nqvtt(a: Array<A?>, b: UShort, c: MutableMap<A, A>): A = TODO()
}

    fun test() = (A.B(53).nqvtt(Arrays.copyOfRange<A?>(Array<A?>(-47, {a: Int -> A()}), -8, 99), 23.toUShort(), Collections.emptySortedMap<A, A>())).test().clone()
}

@Deprecated("ntyhp", ReplaceWith(box(), "ecjkl", "olywi", "rezad"), kotlin.DeprecationLevel.WARNING)
fun box() = (A().test()).toString()



//Combined output:
//org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (10,34) in /home/Anzhela.Sukhanova/fuzzer/JVMCompiler/projectTmp/nonNullArray.kt
//
//Attachments:
//causeThrowable
//java.lang.AssertionError: Recursion detected in a lazy value under LockBasedStorageManager@e153b32 (TopDownAnalyzer for JVM)
...
//@Deprecated("ntyhp", ReplaceWith(<caret>box(), "ecjkl", "olywi", "rezad"), kotlin.DeprecationLevel.WARNING)
//fun box() = (A().test()).toString()
...
//	at java.base/java.util.concurrent.ThreadPoolExecutor$Worker.run(ThreadPoolExecutor.java:628)
//	at java.base/java.lang.Thread.run(Thread.java:829)
//Caused by: java.lang.AssertionError: Recursion detected in a lazy value under LockBasedStorageManager@e153b32 (TopDownAnalyzer for JVM)
//	at org.jetbrains.kotlin.resolve.lazy.descriptors.LazyAnnotationDescriptor.getAllValueArguments(LazyAnnotations.kt:120)
//	at org.jetbrains.kotlin.resolve.annotations.AnnotationUtilKt.argumentValue(AnnotationUtil.kt:37)
//	at org.jetbrains.kotlin.resolve.deprecation.DeprecatedByAnnotation$StandardDeprecated.getDeprecationLevel(Deprecation.kt:43)
//	at org.jetbrains.kotlin.resolve.deprecation.DeprecationResolver.isDeprecatedHidden(DeprecationResolver.kt:88)
