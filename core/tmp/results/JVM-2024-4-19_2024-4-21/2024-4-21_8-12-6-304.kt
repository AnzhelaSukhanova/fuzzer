...
interface B : A {
    override out result: String
}

abstract class AImpl<val Self : Any>(
val r = true
when (r) {
 true -> {override val result: Self) : A}
 else -> {override val result: Self) : A}
}

class BImpl(result: String = "firaz") : AImpl<String>(result), B{
protected var hpfw: Int  
get() = TODO()
set(value) = TODO()
}
