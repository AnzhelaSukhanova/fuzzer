...
fun block(lambda: () -> Unit) {
    ...
    block {
        if (listOf(2, -253991403, 4).first c@{ list.contains(it) } != 769710061) throw AssertionError("Fail")
    }
...
//Combined output:
//org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (14,9) in /home/Anzhela.Sukhanova/fuzzer/JVMCompiler/projectTmp/nestedLambdaInNonInlineCallExactlyOnce.kt
//
//Attachments:
//causeThrowable
//java.lang.StackOverflowError
//	at java.base/java.lang.Class.getCanonicalName0(Class.java:1616)
//	at java.base/java.lang.Class.getCanonicalName(Class.java:1610)
//	at org.jetbrains.kotlin.utils.ExceptionUtilsKt.isProcessCanceledException(exceptionUtils.kt:46)
...
//	at org.jetbrains.kotlin.resolve.deprecation.DeprecationResolver.isHiddenInResolution(DeprecationResolver.kt:112)
...
//
//    block {
//        <caret>list = listOf(-1153404756, 1920099132, 1398152742)
//    }
//
//    block {
//        if (listOf(2, -253991403, 4).first c@{ list.contains(it) } != 769710061) throw AssertionError("Fail")
