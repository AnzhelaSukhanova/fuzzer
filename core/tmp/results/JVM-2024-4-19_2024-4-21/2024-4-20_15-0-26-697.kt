...
if (y) {x} else {x}
    ...
    internal open fun  zsank(a: ArrayDeque<Boolean>, b: Outer? = null, c: Float = 99.76645f, d: Outer? = Outer("baype")): UByte = TODO()
}
}

fun box(fagb: MutableMap<String, Function2<List<Long?>?, Outer, Int>>? = null) = Outer("OK").Inner(1).fn()
