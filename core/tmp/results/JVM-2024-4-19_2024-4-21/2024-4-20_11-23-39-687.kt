...
@Deprecated("ivjuc", ReplaceWith("cqinz", "nesra", box()), kotlin.DeprecationLevel.WARNING)
fun box(): String =
        O::class.myjava1.getSimpleName() + null




//Combined output:
//org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (25,52) in /home/Anzhela.Sukhanova/fuzzer/JVMCompiler/projectTmp/kt11943.kt
//
//Attachments:
//causeThrowable
//java.lang.AssertionError: Recursion detected in a lazy value under LockBasedStorageManager@407c51c6 (TopDownAnalyzer for JVM)
...
//@Deprecated("ivjuc", ReplaceWith("cqinz", "nesra", <caret>box()), kotlin.DeprecationLevel.WARNING)
//fun box(): String =
//        O::class.myjava1.getSimpleName() + null
...
//	at java.base/java.util.concurrent.ThreadPoolExecutor$Worker.run(ThreadPoolExecutor.java:628)
//	at java.base/java.lang.Thread.run(Thread.java:829)
//Caused by: java.lang.AssertionError: Recursion detected in a lazy value under LockBasedStorageManager@407c51c6 (TopDownAnalyzer for JVM)
//	at org.jetbrains.kotlin.resolve.lazy.descriptors.LazyAnnotationDescriptor.getAllValueArguments(LazyAnnotations.kt:120)
//	at org.jetbrains.kotlin.resolve.annotations.AnnotationUtilKt.argumentValue(AnnotationUtil.kt:37)
//	at org.jetbrains.kotlin.resolve.deprecation.DeprecatedByAnnotation$StandardDeprecated.getDeprecationLevel(Deprecation.kt:43)
//	at org.jetbrains.kotlin.resolve.deprecation.DeprecationResolver.isDeprecatedHidden(DeprecationResolver.kt:88)
