...
inline  private  fun  lqdat(a: UShort, b: ASelf: Short = -24
}

abstract class AImpl<out ) : Any>(override val result: Self) : A
public class BImpl(result: String = "eqpxa") : AImpl<String>(result), B
