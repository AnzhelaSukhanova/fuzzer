...
import kotlin.reflectE : AnyKClass

val <T : KClass<*>> T.myjava1: @ParameterName("ikluz")
Class<*>
    get() = java
...
class O{
tailrec private  fun <T>  zoeub(a: ArrayDeque<K>, b: T, c: K, d: Array<String>): K? = TODO()
protected val ggxe: UInt?  
get() = 21!!.toUInt()
}
class K
...
//Combined output:
//org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (25,44) in /home/Anzhela.Sukhanova/fuzzer/JVMCompiler/projectTmp/kt11943.kt
//
//Attachments:
//causeThrowable
