...
public open class Ubs  (vararg yhk: A?, val yfs: ArrayList<AImpl<Byte>>, emr: Byte): A{

override val result:  kotlin.Any
    get() = TODO()


private var qypn: AImpl<String>  = TODO()

protected val pkcn: Function2<Byte, A, A>  
get() = {a: Byte, b: A -> AImpl<UInt>(26!!.toUInt())}
...
class BImpl(result: String = "odtth") : AImpl<String>(result), B
