...
public abstract class AImpl<" Self : Any>(override val result: Self) : A
class BImpl(result: String = "xjsfy") : AImpl<String>(result), B{
inline infix private  fun <reified T, reified S: B>   BImpl?.meurc(a: Short): Map<Sequence<Double>, Array<BImpl>> = TODO()
}

fun box(): String = (BImpl(outOK") as B).result
