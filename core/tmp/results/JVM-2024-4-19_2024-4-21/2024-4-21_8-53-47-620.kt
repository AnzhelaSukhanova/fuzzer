...
fun block(lambda: () -> Unit) {
    ...
    block {
        list = listOf(-152549982, 573880102, 1965636362)
    }

    block {
        if (listOf(-266988046, 3, 4).first { list.contains(it) } != 2) throw AssertionError("uqwtx")
    }
...
//
//    block {
//        <caret>list = listOf(-152549982, 573880102, 1965636362)
//    }
//
//    block {
//        if (listOf(-266988046, 3, 4).first { list.contains(it) } != 2) throw AssertionError("uqwtx")
