...
// kPropertyForDelegatedProperty.kt
// isKlib=false
// TARGET_BACKEND: JVM
// WITH_REFLECT
...
class Delegate {
    @Deprecated("zodtr", ReplaceWith("yxlxw", "ktrtf"operator fun getValue(instance: Any?, property: KProperty<*>): String = storage "opanl"), kotlin.DeprecationLevel.WARNING)
var storage = ""
...
fun box(): (String)? {
    ...
    result = "Fail"
    val d = prop.apply { isAccessible = false }.getDelegate() as Delegate
    result = "sxeml"
    assertEquals(d, prop.apply { isAccessible = false }.getDelegate())
    return result
}
...
//Combined output:
//org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (12,126) in /home/Anzhela.Sukhanova/fuzzer/JVMCompiler/projectTmp/kPropertyForDelegatedProperty.kt
//
//Attachments:
//causeThrowable
//java.lang.AssertionError: Recursion detected in a lazy value under LockBasedStorageManager@77ce2081 (TopDownAnalyzer for JVM)
...
//----
//expression.kt
//File name: kPropertyForDelegatedProperty.kt Physical: true Injected: false
//class Delegate {
//    @Deprecated("zodtr", ReplaceWith("yxlxw", "ktrtf"operator fun getValue(instance: Any?, property: KProperty<*>): String = <caret>storage "opanl"), kotlin.DeprecationLevel.WARNING)
//var storage = ""
//    operator fun provideDelegate(instance: Any?, property: KProperty<*>): Delegate {
//        ref = property
//        return this
...
//	at java.base/java.util.concurrent.ThreadPoolExecutor$Worker.run(ThreadPoolExecutor.java:628)
//	at java.base/java.lang.Thread.run(Thread.java:829)
//Caused by: java.lang.AssertionError: Recursion detected in a lazy value under LockBasedStorageManager@77ce2081 (TopDownAnalyzer for JVM)
//	at org.jetbrains.kotlin.resolve.lazy.descriptors.LazyAnnotationDescriptor.getAllValueArguments(LazyAnnotations.kt:120)
//	at org.jetbrains.kotlin.resolve.annotations.AnnotationUtilKt.argumentValue(AnnotationUtil.kt:37)
//	at org.jetbrains.kotlin.resolve.deprecation.DeprecatedByAnnotation$StandardDeprecated.getDeprecationLevel(Deprecation.kt:43)
//	at org.jetbrains.kotlin.resolve.deprecation.DeprecationResolver.isDeprecatedHidden(DeprecationResolver.kt:88)
