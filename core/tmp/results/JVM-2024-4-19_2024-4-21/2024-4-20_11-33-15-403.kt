...
fun box(): String =
        O::class.myjava1.getSimpleName()!! + K::class.myjava2.
val n = true
try
{getSimpleName}
catch(e: Exception){}
...
//Combined output:
//org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (22,46) in /home/Anzhela.Sukhanova/fuzzer/JVMCompiler/projectTmp/kt11943.kt
//
//Attachments:
//causeThrowable
...
//fun box(): String =
//        O::class.myjava1.getSimpleName()!! + <caret>K::class.myjava2.
