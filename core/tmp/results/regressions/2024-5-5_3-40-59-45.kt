...
val k = s()
    ...
    external  open fun  bghob(a: Short = 89, b: (MutableMap<UShort, IssueState>)? = null, c: Function2<UInt, Boolean, IssueState?>): IssueState?
};

    open fun ToString() : (@UseExperimental(Annotation::class, Annotation::class)
String)? = "wcrgu"
}
