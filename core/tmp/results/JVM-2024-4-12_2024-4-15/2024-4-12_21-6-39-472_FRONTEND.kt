...
class Pair<return if (v == null) "OK" else "fail">(a: A)

fun box(): String {
    val v = foo<Pair<Byte>>(Pair<Byte>(68))
    A
}
...
Combined output:
org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (8,29) in /home/Anzhela.Sukhanova/fuzzer/JVMCompiler/projectTmp/kt2739.kt
...
fun box(): String {
    val v = foo<Pair<Byte>>(<caret>Pair<Byte>(68))
    A
}
