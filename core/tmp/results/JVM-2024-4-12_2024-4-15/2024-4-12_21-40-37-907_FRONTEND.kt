...
tailrec fun box(aygn: Function1<Byte, Pair<Long?>>): String {
    val v = foo(Pair((box(o@{a: Byte -> Pair(24)})).compareTo(box(t@{a: Byte -> Pair(55)})).div(21A))
    
val g = false
if (g) {return if (v == null) "OK" else "fail"} else {return if (g) "OK" else "fail"}
...
Combined output:
org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (8,41) in /home/Anzhela.Sukhanova/fuzzer/JVMCompiler/projectTmp/kt2739.kt
...
tailrec fun box(aygn: Function1<Byte, Pair<Long?>>): String {
    val v = foo(Pair((box(o@{a: Byte -> <caret>Pair(24)})).compareTo(box(t@{a: Byte -> Pair(55)})).div(21A))
