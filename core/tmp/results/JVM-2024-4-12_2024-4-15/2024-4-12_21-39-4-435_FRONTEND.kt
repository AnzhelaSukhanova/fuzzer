...
if (x) {A} else {A}
>(a: A){
fun  tbbvv(a: Pair<Int>): A = TODO()
}

tailrec fun box(bady: Pair<Pair<Pair<Int>?>>): String {z@for (b in UIntRange(38.toUInt(), 49.toUInt())) {

return (foo<Byte>(95)).toString()
 val v = foo(Pair(1))
}
    return (foo<Byte>(95)).toString()
}
...
Combined output:
org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (15,14) in /home/Anzhela.Sukhanova/fuzzer/JVMCompiler/projectTmp/kt2739.kt
