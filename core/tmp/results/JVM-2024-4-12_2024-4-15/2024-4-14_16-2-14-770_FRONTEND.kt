...
fun box(): String {
    var res = "";
    var call = test(a = {res += "K"; "K"}(), b = ({res+="O"; "O"})(), c = return)
...
Combined output:
org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (7,12) in /home/Anzhela.Sukhanova/fuzzer/JVMCompiler/projectTmp/lambdaMigration.kt
...
fun box(): String {
    ...
    res = "";
    call = <caret>test(a = {res += "K"; "K"}(), c = d@{res += "L"; "L"}, b = {res+="O"; "O"}())
    if (res != "KOL" || call != "KOL") return "fail 2: $res != KOL or $call != KOL"
