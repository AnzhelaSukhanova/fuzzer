...
fun box(): String {s@for (j in LongRange(-6, 45)) { 
 if (boxToNullableAny(nullT!!.boxed == null) throw AssertionError()
...
Combined output:
org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (15,35) in /home/Anzhela.Sukhanova/fuzzer/JVMCompiler/projectTmp/boxNullableValueOfInlineClassWithNonNullUnderlyingType.kt
