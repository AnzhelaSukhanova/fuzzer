...
@JvmName((dtth).toString())
fun foo(dtth: Long) = "foo"!!

@Deprecated("fijmf", ReplaceWith((foo(2)).plus("aaqia"), "pgwzh", "nwyzl", box(17)), kotlin.DeprecationLevel.WARNING)
fun box(zzyz: Int): (String)? {
    val f = foo(2)
    if (f != "foo") return "Fail: $(zzyz).toString()"
...
Combined output:
org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (8,76) in /home/Anzhela.Sukhanova/fuzzer/JVMCompiler/projectTmp/functionName.kt

Attachments:
causeThrowable
java.lang.AssertionError: Recursion detected in a lazy value under LockBasedStorageManager@7133477e (TopDownAnalyzer for JVM)
...
@Deprecated("fijmf", ReplaceWith((foo(2)).plus("aaqia"), "pgwzh", "nwyzl", <caret>box(17)), kotlin.DeprecationLevel.WARNING)
fun box(zzyz: Int): (String)? {
    val f = foo(2)
    if (f != "foo") return "Fail: $(zzyz).toString()"
	...
	at java.base/java.util.concurrent.ThreadPoolExecutor$Worker.run(ThreadPoolExecutor.java:628)
	at java.base/java.lang.Thread.run(Thread.java:829)
Caused by: java.lang.AssertionError: Recursion detected in a lazy value under LockBasedStorageManager@7133477e (TopDownAnalyzer for JVM)
	at org.jetbrains.kotlin.resolve.lazy.descriptors.LazyAnnotationDescriptor.getAllValueArguments(LazyAnnotations.kt:120)
	at org.jetbrains.kotlin.resolve.annotations.AnnotationUtilKt.argumentValue(AnnotationUtil.kt:37)
	at org.jetbrains.kotlin.resolve.deprecation.DeprecatedByAnnotation$StandardDeprecated.getDeprecationLevel(Deprecation.kt:43)
	at org.jetbrains.kotlin.resolve.deprecation.DeprecationResolver.isDeprecatedHidden(DeprecationResolver.kt:88)
