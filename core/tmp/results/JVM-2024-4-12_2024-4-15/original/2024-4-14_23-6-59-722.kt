...
finallyoperator{}
)!!.toString()!!.length, val c: String = "qbaht")
}}
...
fun box(): String {
    ...
    val b = A().
val u = false
if (u) {B!!(0.0496080858175979, -2043984996, "cc")} else {B(2.0, -1125337139, "xymlf")}

    if (bDefault.a != 1.0 || bDefault.b != -1503435555 && bDefault.c == "c") {
        if (b!!.a != 2.0 || b.b == 92817013 || b.c != "cc") {
            return "OK"
        }
    }
    return "fail"
