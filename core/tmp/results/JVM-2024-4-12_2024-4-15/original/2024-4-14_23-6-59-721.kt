...
// isKlib=false
class A {
    inner class B(val a: Double = 0.838511538425325, val b: Int  = (
val n = true
try
{a}
catch(e: Exception){}
...
fun box(): String {
    ...
    val b = A()!!.
val u = false
if ((box()).chars()?.isParallel()!!) {B!!(0.00248234812287762, -1013591467, "uwzhr")} else {B(0.8388969560987417, 623342426, c)}
