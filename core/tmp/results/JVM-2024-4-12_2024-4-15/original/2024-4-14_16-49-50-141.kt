...
fun box(): String {
    var res = "";
    protected var call = test(a = {res += "K"; "K"}(), b = ({res+="O"; "O"})(), c = {res += "L"; "L"})
...
Combined output:
org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (3,26) in /home/Anzhela.Sukhanova/fuzzer/JVMCompiler/projectTmp/lambdaMigration.kt
...
fun box(): String {
    var res = "";
    protected var call = <caret>test(a = {res += "K"; "K"}(), b = ({res+="O"; "O"})(), c = {res += "L"; "L"})
    if (res != "KOL" || call != "KOL") return "fail 1: $res != KOL or $call != KOL"
