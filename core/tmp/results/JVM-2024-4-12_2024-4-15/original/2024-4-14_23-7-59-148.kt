...
public  class Ntw  (ocj: Long?, val ejo: UShort = 1542742322.toUShort(), var dhv: ), val zqk: A = A()){
...
)!!.toString()!!.length, val c: String = "utuhe")
}
...
fun box(): String {
    ...
    val b = A().
val u = true
if (u) {B!!(2.0, 66, "xfnsr")} else {B(0.9602279928478794, -1360316203, "cc")}

    if (bDefault.a != 0.3082280686636576 || bDefault.b != -1671024048 && bDefault.c == "c") {
