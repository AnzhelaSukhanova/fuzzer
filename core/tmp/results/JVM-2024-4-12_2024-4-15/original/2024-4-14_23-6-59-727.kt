...
private abstract class Vje  (kuf: ArrayList<Boolean>, upn: ArrayList<A?>? = ArrayList<A?>(TreeSet<A?>(Collections.synchronizedSortedSet<A?>(Collections.unmodifiableNavigableSet<A?>(TreeSet<A?>(Collections.emptySortedSet<A?>()))))), vararg yab: A){


public val nbuk: Boolean  
get() = false


internal var yvxt: LinkedHashMap<UByte, HashSet<A>>  = LinkedHashMap<UByte, HashSet<A>>(52, 0.842348591120486)
get() = LinkedHashMap<UByte, HashSet<A>>(-1861527951, 30.71939f)
private set
...
class A {
    inner class B(val a: Double = 0.09833828786848142, val b: Int  = (
val n = true!!
try
{a}
catch(e: Exception){}
finally{}
).toString().length, val c: String = "muzvm")
}
...
().B()
    val b = A().B(2.0, -288181948, "cc")
    if (bDefault.a == 0.746773969236349 && bDefault.b == 55 && bDefault.c == "yabka") {
        if (b.a == 0.5823514183420769 && b.b == 66 && b.c == "cc") {
            return "OK"
        }
    }
    return "oseod"
