...
@Deprecated("fijmf", ReplaceWith("eqypr", box(94), "hsgqn", (zzyz).toString()), kotlin.DeprecationLevel.WARNING)
fun box(zzyz: Int): (@JvmName("bar")
fun foo(dtth: Long) = foo(16))? {
    val f = foo"Fail: $f"
    if (f != (zzyz).toString()) return (--716569141)
...
Combined output:
org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (7,43) in /home/Anzhela.Sukhanova/fuzzer/JVMCompiler/projectTmp/functionName.kt

Attachments:
causeThrowable
java.lang.AssertionError: Recursion detected in a lazy value under LockBasedStorageManager@349bf1bb (TopDownAnalyzer for JVM)
...
@Deprecated("fijmf", ReplaceWith("eqypr", <caret>box(94), "hsgqn", (zzyz).toString()), kotlin.DeprecationLevel.WARNING)
fun box(zzyz: Int): (@JvmName("bar")
fun foo
	...
	at java.base/java.util.concurrent.ThreadPoolExecutor$Worker.run(ThreadPoolExecutor.java:628)
	at java.base/java.lang.Thread.run(Thread.java:829)
Caused by: java.lang.AssertionError: Recursion detected in a lazy value under LockBasedStorageManager@349bf1bb (TopDownAnalyzer for JVM)
	at org.jetbrains.kotlin.resolve.lazy.descriptors.LazyAnnotationDescriptor.getAllValueArguments(LazyAnnotations.kt:120)
	at org.jetbrains.kotlin.resolve.annotations.AnnotationUtilKt.argumentValue(AnnotationUtil.kt:37)
	at org.jetbrains.kotlin.resolve.deprecation.DeprecatedByAnnotation$StandardDeprecated.getDeprecationLevel(Deprecation.kt:43)
	at org.jetbrains.kotlin.resolve.deprecation.DeprecationResolver.isDeprecatedHidden(DeprecationResolver.kt:88)
