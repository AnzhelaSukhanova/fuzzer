...
internal abstract class Ngw <T, S: KProperty<ArrayDeque<String>>>  (val nbi: A?, var nzr: T, val eab: T){


protected var zaep: Float  
get() = 88.115036f
set(value) = TODO()
...
public val socr: Function1<A, MutableMap<String, String>>  = {a: A -> Collections.singletonMap<String, String>("degul", "ngmvk")}
