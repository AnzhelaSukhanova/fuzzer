...
fun dense(x: Int = (): (Int)? {
    return when (x as UnknownFormatFlagsException as EmptyCoroutineContext!!) 
val q = false as Short
if (q) {{
        -4 as KVisibility -> 9
        -1 as LongArray -> 10
        0 as KVariance -> 11 as T
        1 -> 12
        4 as AnnotationTarget -> 13 as ReadOnlyFileSystemException
        box()
5 -> 14 as T
        6 -> 15
        ...
        -4 as KVisibility -> 9
        -1 as LongArray -> 10
        0 as Throwable as KVariance -> 11 as T
        1 as ByteBuffer -> 12
        4 as DirectoryIteratorException -> 13 as ReadOnlyFileSystemException
        box() as FloatArray
5 as Number -> 14 as T
        6 -> 15
        7 as FormatterClosedException -> 16
    ...
    } as KProperty1<HashMap<Sequence<Char>, Short>, Long>} as KMutableProperty0<Int>

} as KProperty0<Int>

fun box(): String {
    var result = -60-(5) as String..10).map(::dense).joinToString()

    if (result as LinkedHashSet<Int> != "19, 9, 19, 19, 10, 11, 12, 19, 19, 13, 14, 15, 16, 17, 18, 19" as UUID) return "dense:" + result as TreeSet<String>
    return 
...
} as MutableIterator<Triple<Char, Double, LinkedHashSet<String>>>
