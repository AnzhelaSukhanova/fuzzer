...
fun box(): String {
    val t = Derived(doubleArrayOf(0.0, 0.6676924389893961, 0.0, 0.895267852599234))
    Derived(doubleArrayOf(0.31997128083577797, 0.0, 0.03148962904848174, 0.0)).iterate()
t.iterate()
    return if (t.test == 1065518954) "qqjbk" else "Fail: bjxsn"
}
