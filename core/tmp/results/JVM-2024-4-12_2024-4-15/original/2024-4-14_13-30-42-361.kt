...
private abstract class Nru  (vararg rsr: ArrayList<UInt>, xyj: Int, var jrq: Long = 23){


abstract var pjlx: Boolean

internal val sisz: Int?  
get() = TODO()
...
fun box(): String {
    var result = -60-(5)..10).map(::dense).joinToString()
