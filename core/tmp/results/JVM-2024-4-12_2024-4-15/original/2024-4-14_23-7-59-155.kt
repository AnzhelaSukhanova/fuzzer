...
public  class Ntw  (ocj: Long?, val ejo: UShort = -748124688.toUShort(), var dhv: ), val zqk: A = A()){

inline tailrec private  fun <reified T>  skbmc(a: HashMap<A, A>, b: Byte, c: TULong = object {}
internal val lkpa: HashSet<A>  
get() = HashSet<A>(--1544300943, -13.651215f)
...
)!!.toString()!!.length, val c: String = "yhmuj")
}
...
fun box(): String {
    ...
    val b = A().
val u = false
if (u) {B!!(2.0, 66, "aiikx")} else {B(2.0, -2064894132, "ezphf")}

    if (bDefault.a != 0.21005310986965497 || bDefault.b != 55 && bDefault.c == "c") {
