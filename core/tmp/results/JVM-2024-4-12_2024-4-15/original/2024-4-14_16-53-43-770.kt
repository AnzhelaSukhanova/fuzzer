...
fun box(): String {
    var res = "";
    internal var call = test(a = {res += "K"; "K"}(), b = ({res+="O"; "O"})(), c = k@{res += "L"; "L"})
...
Combined output:
org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (3,25) in /home/Anzhela.Sukhanova/fuzzer/JVMCompiler/projectTmp/lambdaMigration.kt
...
fun box(): String {
    var res = "";
    internal var call = <caret>test(a = {res += "K"; "K"}(), b = ({res+="O"; "O"})(), c = k@{res += "L"; "L"})
    if (res != "KOL" || call != "KOL") return "fail 1: $res != KOL or $call != KOL"
