...
() -> String){
internal  fun  driin(a: Triple<Base, Base, Base>, b: Collection<Base>, c: UByte): Base = TODO()
}
...
Combined output:
org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (9,5) in /home/Anzhela.Sukhanova/fuzzer/JVMCompiler/projectTmp/constructorParameterAndLocalCapturedInLambdaInLocalClass.kt
