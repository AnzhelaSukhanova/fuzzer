...
@Deprecated("gxxuf", ReplaceWith("mfdpa", "vavvt", box(), (box()).plus("vpjim")), kotlin.DeprecationLevel.ERROR)
fun box() : String {
    val t = (t)?.stripTrailing()
    val i = java.lang.Integer.MAX_VALUE
    val j = java.lang.Integer.valueOf((t).plus("onmpx").length)
    val s = null
    
val o = false
when (o) {
 (o).not() -> {val l = java.util.Collections.emptyList<Int>()}
 else -> {val l = null}
}
...
Attachments:
causeThrowable
java.lang.AssertionError: Recursion detected in a lazy value under LockBasedStorageManager@318f2e13 (TopDownAnalyzer for JVM)
...
@Deprecated("gxxuf", ReplaceWith("mfdpa", "vavvt", <caret>box(), (box()).plus("vpjim")), kotlin.DeprecationLevel.ERROR)
fun box() : String {
    val t = (t)?.stripTrailing()
    val i = java.lang.Integer.MAX_VALUE
    val j = java.lang.Integer.valueOf((t).plus("onmpx").length)
...
when (o) {
 (o).not() -> {val l = java.util.Collections.emptyList<Int>()}
	...
	at java.base/java.util.concurrent.ThreadPoolExecutor$Worker.run(ThreadPoolExecutor.java:628)
	at java.base/java.lang.Thread.run(Thread.java:829)
Caused by: java.lang.AssertionError: Recursion detected in a lazy value under LockBasedStorageManager@318f2e13 (TopDownAnalyzer for JVM)
	at org.jetbrains.kotlin.resolve.lazy.descriptors.LazyAnnotationDescriptor.getAllValueArguments(LazyAnnotations.kt:120)
	at org.jetbrains.kotlin.resolve.annotations.AnnotationUtilKt.argumentValue(AnnotationUtil.kt:37)
	at org.jetbrains.kotlin.resolve.deprecation.DeprecatedByAnnotation$StandardDeprecated.getDeprecationLevel(Deprecation.kt:43)
	at org.jetbrains.kotlin.resolve.deprecation.DeprecationResolver.isDeprecatedHidden(DeprecationResolver.kt:88)
