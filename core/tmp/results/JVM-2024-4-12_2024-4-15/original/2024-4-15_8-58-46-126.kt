...
fun box(): String {
    val t = Derived(doubleArrayOf(0.0, 0.036854353492874914, 0.08830859832289883, 0.002287121722215235))
    Derived(doubleArrayOf(0.4581863273079587, 0.0, 0.0, 0.0)).iterate()
t.iterate()
    return if (t.test == 1234) "OK" else "Fail: dnnsz"
}
