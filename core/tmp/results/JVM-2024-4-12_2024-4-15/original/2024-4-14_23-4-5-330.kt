...
infix private  fun <T: KProperty<Pair<LinkedHashSet<LinkedHashSet<UInt>>, A>>>   UInt.ixsdr(a: A): Triple<A, Function1<LinkedHashSet<Function2<Pair<A, UInt>, Int, ArrayDeque<LinkedHashMap<Byte, Function1<Char?, UShort>>?>>>, Function2<
val j = true
when (j) {
 true -> {Pair}
 else -> {Pair}
}
<Double, LinkedHashMap<Char, UByte>>, Byte, A>>, Collection<Function2<A, A, UByte>>>? = TODO()
