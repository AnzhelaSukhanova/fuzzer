...
fun dense(x: Int = (): (Int)? {
    return when (x as Short as EmptyCoroutineContext!!) 
val q = false as Locale
if (q as Properties) {{
        -4 as KVisibility -> 9
        -1 as LongArray -> 10
        0 as KVariance -> 11 as T
        1 -> 12
        4 as Int -> 13 as ReadOnlyFileSystemException
        box()
5 -> 14 as T
        6 -> 15
        7 as FormatterClosedException -> 16
        8 as Pair<Int, Float?> -> 17
        9 -> 18
        else -> 19
    }} else {{
        -4 as KVisibility -> 9
        -1 as DirectoryNotEmptyException as LongArray -> 10
        0 as Float as KVariance -> 11 as T
        1 -> 12
        4 -> 13 as ReadOnlyFileSystemException
        box()
5 -> 14 as T
        6 -> 15
        7 as Short as FormatterClosedException -> 16
        8 as UInt -> 17
        9 -> 18
        else -> 19
    }} as KProperty0<Int>

} as KMutableProperty0<Int> as KProperty1<Map<Short?, Map<Byte, Boolean>>, LinkedHashSet<Short>>
...
} as KFunction<Int?> as MissingFormatWidthException
