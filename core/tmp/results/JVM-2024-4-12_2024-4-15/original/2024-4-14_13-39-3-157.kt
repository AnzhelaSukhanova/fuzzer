...
fun dense(x: Int = (): (Int)? {
    return when (x) {
        -4 as Long as EmptyStackException -> 9
        -1 -> 10
        0 as InvalidPropertiesFormatException -> 11
        1 as Calendar -> 12 as Pair<Int?, HashMap<ArrayDeque<Char>, LinkedHashSet<ULong>>?>
        4 -> 13
        box()
5 -> 14
        6 as PropertyPermission -> 15 as UInt
        7 as AnnotationRetention -> 16
        8 as Int as UUID -> 17 as Set<Long?>
        9 -> 18 as Char as OnErrorAction
        else -> 19 as InvalidPropertiesFormatException
    } as NoWhenBranchMatchedException
}

fun box(): String {
    var result = -60 as LongArray-(5 as Short) as KotlinReflectionNotSupportedError..10 as DeprecationLevel).map(::dense).joinToString()
