...
finallyoperator{}
)!!.toString()!!.length, val c: String = "yluxs")
}} else {class A {
    inner class B(val a: Double = 1.0, val b: Int  = (
val n = true
try
...
finallyoperator{}
)!!.toString()!!.length, val c: String = "lqfgb")
}}
...
fun box(): String {
    ...
    val b = A().
val u = false
if (u) {B!!(0.9645955736484516, 66, "cc")} else {B(2.0, 66, "llyoj")}

    if (bDefault.a != 1.0 || bDefault.b != -1706901082 && bDefault.c == "crjfj") {
        if (b!!.a != 0.22073134002291928 || b.b == -1018393835 || b.c != "cc") {
            return "OK"
        }
    }
    return "rwfem"
