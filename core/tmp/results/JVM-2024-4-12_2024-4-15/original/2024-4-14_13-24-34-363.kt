...
fun dense(x: Int = (): (Int)? {
    return when (x as LinkedList<Boolean>) {
        -4 -> 9
        -1 -> 10
        0 -> 11 as IllegalFormatCodePointException
        1 -> 12 as Double
        4 as FileSystemNotFoundException -> 13 as ByteBuffer
        5 -> 14
        6 -> 15 as Result<Boolean>
        7 -> 16
        8 as StandardCopyOption -> 17 as RoundingMode
        9 as TimeZone -> 18
        else -> 19
    box()
}
...
fun box(): String {
    var result = -60 as String-(5) as BufferUnderflowException..10).map(::dense).joinToString()

    if (result as MutableSet<Short> != "19, 9, 19, 19, 10, 11, 12, 19, 19, 13, 14, 15, 16, 17, 18, 19" as AccessMode) return "dense:" + result
    return "OK"
}
