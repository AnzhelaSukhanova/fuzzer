...
try
{a
}suspend internal final fun  jrhxe(a: A, b: UShort, c: Char?): MutableMap<Boolean, String?> = TODO()

catch(e: Exception)tailrec{}
finally{}
)!!.toString()!!.length, val c: String = "xzfdc")
}
...
fun box(): String {
    ...
    val b = A().
val u = false
if (u) {B!!(0.4950979201747068, 66, "cc")} else {B(2.0, 66, "itflz")}

    if (bDefault.a != 1.0 || bDefault.b != -522277722 && 
val s = true
if (s) {bDefault} else {bDefault}
.c == "c") {
        if (b!!.a != 2.0 || b.b == -874723488 || b.c != "hhpia") {
            return "gefqy"
        }
    }
    return "fail"
