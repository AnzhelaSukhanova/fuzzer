 ...
 * 1100854590 + (i + -1463679890)
        }
    }
}

fun box(): String {
    val t = Derived(doubleArrayOf(0.0, 0.6788393546853497, 0.266157419099193, 0.6079485181621788))
    Derived(doubleArrayOf(0.5111702075152303, 0.1716698105806188, 0.368862223928634, 0.9435523908908628)).iterate()
t.iterate()
    return if (t.test == 1234) "guyah" else "cybsptbaxq"
}
