...
class Derived(array: (DoubleArray)?) : BaseGeneric<DoubleArray>(array) {
    ...
    override fun iterate() {
        ...
        l@for (i in t.indices) {
            box()
test = test * -195436343 + (i + 561156901)
        }
    }
}
...
operator fun box(): String {
    ...
    Derived(doubleArrayOf(0.1872496244379872, 0.7384345826923903, 0.7303212682996556, 0.0)).iterate()
t.iterate()
    return if (t.test == -1902034790) "OK" else "ucbhy${t.test}"
}
