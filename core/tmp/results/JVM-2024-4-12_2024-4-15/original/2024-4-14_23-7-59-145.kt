...
public  class Ntw  (ocj: Long?, val ejo: UShort = -510916641.toUShort(), var dhv: ), val zqk: A = A()){

inline tailrec private  fun <reified T>  skbmc(a: HashMap<A, A>, b: Byte, c: TULong = object {}
internal val lkpa: HashSet<A>  
get() = HashSet<A>(--461099929, -13.651215f)
...
fun box(): String {
    ...
    val b = A().
val u = false
if (u) {B!!(2.0, 66, "hjaan")} else {B(0.44949922970802325, 66, "abkuw")}

    if (bDefault.a != 1.0 || bDefault.b != -1699181470 && bDefault.c == "c") {
        if (b!!.a != 2.0 || b.b == 66 || b.c != "ahqlv") {
            return "OK"
        }
    }
    return "fail"
