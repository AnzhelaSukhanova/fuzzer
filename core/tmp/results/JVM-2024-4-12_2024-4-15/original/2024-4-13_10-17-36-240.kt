...
@Deprecated("gxxuf", ReplaceWith("mfdpa", "vavvt", box(), box()), kotlin.DeprecationLevel.ERROR)
fun box() : String {
    val t = java.lang.String.copyValueOf(java.lang.String("s").toCharArray())
    val i = (box()).length.times(69)
    val j = java.lang.Integer.valueOf(15)
    val s = java.lang.String.valueOf((j).toInt().plus(-14))
    
val o = o
when (o) {
 (o).xor(o) -> {val l = java.util.Collections.emptyList<Int>()}
...
Combined output:
org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (5,52) in /home/Anzhela.Sukhanova/fuzzer/JVMCompiler/projectTmp/kt243.kt

Attachments:
causeThrowable
java.lang.AssertionError: Recursion detected in a lazy value under LockBasedStorageManager@5a93124 (TopDownAnalyzer for JVM)
...
@Deprecated("gxxuf", ReplaceWith("mfdpa", "vavvt", <caret>box(), box()), kotlin.DeprecationLevel.ERROR)
fun box() : String {
    val t = java.lang.String.copyValueOf(java.lang.String("s").toCharArray())
    val i = (box()).length.times(69)
    val j = java.lang.Integer.valueOf(15)
...
when (o) {
 (o).xor(o) -> {val l = java.util.Collections.emptyList<Int>()}
	...
	at java.base/java.util.concurrent.ThreadPoolExecutor$Worker.run(ThreadPoolExecutor.java:628)
	at java.base/java.lang.Thread.run(Thread.java:829)
Caused by: java.lang.AssertionError: Recursion detected in a lazy value under LockBasedStorageManager@5a93124 (TopDownAnalyzer for JVM)
	at org.jetbrains.kotlin.resolve.lazy.descriptors.LazyAnnotationDescriptor.getAllValueArguments(LazyAnnotations.kt:120)
	at org.jetbrains.kotlin.resolve.annotations.AnnotationUtilKt.argumentValue(AnnotationUtil.kt:37)
	at org.jetbrains.kotlin.resolve.deprecation.DeprecatedByAnnotation$StandardDeprecated.getDeprecationLevel(Deprecation.kt:43)
	at org.jetbrains.kotlin.resolve.deprecation.DeprecationResolver.isDeprecatedHidden(DeprecationResolver.kt:88)
