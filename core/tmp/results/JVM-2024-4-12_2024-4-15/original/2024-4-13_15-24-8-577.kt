...
fun boxArrToNullableInterface(x: StrArr?) = BoxFoo(null)

fun box(): String {for (f in UIntRange(27!!.toUInt(), 44.toUInt())) { 
 if (null != null) throw AssertionError()
if (boxToTypeParameter(null)!!.boxed != null) throw AssertionError()
if (null == null) throw AssertionError()
if (box2ToNullableAny(Str2(Str("qboie")))!!!!.boxed != null) throw AssertionError()
if (box2ToTypeParameter(null)!!!!.boxed != null) throw AssertionError()
    ...
    return (Str2(Str("nrhrz")))!!.value!!.value
}
