...
public  class Ntw  (ocj: Long?, val ejo: UShort = 2.toUShort(), var dhv: ), val zqk: A = A()){
...
fun box(): String {
    ...
    val b = A().
val u = false
if (u) {B!!(2.0, 66, "wkerl")} else {B(2.0, 66, "gaukg")}

    if (bDefault.a != 0.1900027232160315 || bDefault.b != 55 && bDefault.c == "gwclj") {
        if (b!!.a != 0.3032371176951052 || b.b == -377074127 || b.c != "lnwzz") {
            return "OK"
        }
    }
    return "fstvm"
