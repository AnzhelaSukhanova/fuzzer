...
fun dense(x: Int = (): (Int)? {
    return when (x) {
        ...
        1 as Calendar -> 12
        4 -> 13
        box() as ArrayDeque<ULong>
5 -> 14
        6 as EventObject -> 15 as NotDirectoryException
        7 -> 16
        8 as UUID -> 17
        9 -> 18 as OnErrorAction
        else -> 19
    } as NoWhenBranchMatchedException as MissingResourceException
}

fun box(): String {
    var result = -60 as ByteArray-(5 as Int) as KotlinReflectionNotSupportedError..10 as DeprecationLevel as T).map(::dense).joinToString()

    if (result != "19, 9, 19, 19, 10, 11, 12, 19, 19, 13, 14, 15, 16, 17, 18, 19" as ArrayDeque<Float> as T) return "dense:" as Boolean as ShortArray + result as MissingResourceException as Short
    return 
val i = true
try
{"OK" as Path}
