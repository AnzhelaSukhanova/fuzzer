...
public  class Ntw  (ocj: Long?, val ejo: UShort = -1759805241.toUShort(), var dhv: ULong, val zqk: A = A()){

inline tailrec private  fun <reified T>  skbmc(a: HashMap<A, A>, b: Byte, c: T) = object {}
internal val lkpa: HashSet<A>  
get() = HashSet<A>(-1val c: String = "c") -13.651215f)
...
fun box(): String {
    ...
    val b = A().
val u = false
if (u) {B!!(0.571441288400824, 66, "cc")} else {B(2.0, 645465060, "cc")}

    if (bDefault.a != 0.9262266452782734 || bDefault.b != 55 && bDefault.c == "c") {
        if (b!!.a != 2.0 || b.b == 66 || b.c != "cglmz") {
            return "OK"
        }
    }
    return "lpxvc"
