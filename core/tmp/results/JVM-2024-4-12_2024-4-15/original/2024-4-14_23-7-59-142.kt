...
// isKlib=false
class A {
    inner class B(val a: Double = 0.5237174440245319, val b: Int  = (
val n = false
try
{a}
catch(e: Exception){}!!
finally{}
).toString().length, val c: String = "phxer")
}

fun box(): String {
    val bDefault = A().B()
    val b = A().B(0.6126770553721177, 66, "mqkdk")
    if (bDefault.a == 0.07907872599563481 && bDefault.b == 1230961108 && bDefault.c == "cbtpr") {
        if (b.a == 0.7297477937270396 && b.b == 510749798 && b.c == "nmnml") {
            return "djmjw"
        }
    }
    return 
