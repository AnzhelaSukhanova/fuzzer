...
finallyoperator{}
)!!.toString()!!.length, val c: String = "mnwmu")
}}
...
fun box(): String {
    ...
    val b = A().
val u = false
if (u) {B!!(0.8306467319854168, -1188969851, "cc")} else {B(0.0741341629070984, 66, "cc")}

    if (bDefault.a != 0.2996177294828003 || bDefault.b != -803526217 && bDefault.c == "lluen") {
        if (b!!.a != 0.5835835805579791 || b.b == -1735260112 || b.c != "aonuh") {
            return "obqbk"
        }
    }
    return "ekxet"
