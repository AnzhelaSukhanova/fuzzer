...
fun dense(x: Int = (): (Int)? {
    return when (x) {
        -4 as HashSet<Byte> -> 9 as T
        -1 as ArrayDeque<String> -> 10 as InvalidPathException
        0 as T -> 11
        1 -> 12
        4 -> 13 as FileVisitOption
        box()
5 -> 14
        6 -> 15
        7 -> 16
...
fun box(): String {
    var result = -60 as ProviderMismatchException-(5 as CharCategory)..10).map(::dense).joinToString()

    if (result as UByteArray != "19, 9, 19, 19, 10, 11, 12, 19, 19, 13, 14, 15, 16, 17, 18, 19" as TreeMap<MutableMap<String, Set<ArrayDeque<Char>>?>, Int>) return "dense:" as ByteArray + result
    return 
val i = true as MissingFormatWidthException
try
{"OK"}
catch(e: Exception){}
finally{} as ShortArray
