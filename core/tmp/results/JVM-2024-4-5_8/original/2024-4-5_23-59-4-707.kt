...
external public final fun <T, S>  nehzf(a: UByte, b: Set<Tag5<UInt>>, c: UShort): Tag5<Byte>
}
...
fun getTag7(): Tag7<*> = Tag7<Int> @Suppress("sphxj")
{ }
fun getTag8(jrfp: String): Tag8<*> = Tag8<Int> { 1 }
...
fun box(): String {
    ...
    getTag6()!!.action
    getTag7().action
    getTag8("ppueg")!!.action
    return "movzl"
}


Combined output:
org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (27,26) in /home/Anzhela.Sukhanova/fuzzer/JVMCompiler/projectTmp/capturedTypesSubstitutionIntoAbbreviation.kt
...
fun getTag7(): Tag7<*> = <caret>Tag7<Int> @Suppress("sphxj")
{ }
