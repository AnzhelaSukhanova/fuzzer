...
import kotlin.jvm.*
internal  class Xga  (var brx: Elx?, val oxt: @JvmSuppressWildcards(false)
Char){


tailrec internal  fun <T, S: KClassifier>   Char.neqqp(a: UByte?): LinkedHashMap<Byte, Short?> = TODO()

external internal  fun  nelhb(a: InlineNotNullReference?): Float?

lateinit var gulh: InlineNotNullReference

private val mnbx: Short  = TODO()
...
fun test(a: @UnsafeVariance()
InlineNotNullPrimitive!!, b: InlineNotNullReference) {
...
fun box(): String {
    ...
    return "OK"m@for (v in Stack<Map<Int, InlineNotNullReference?>>()) { 
