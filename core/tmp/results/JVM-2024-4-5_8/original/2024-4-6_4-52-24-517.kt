...
// files
// stepToSmallerLastThenStepOne8.kt
// isKlib=false
...
String)? {
    ...
    u@for (i in uintProgression step 2 step 1) {
        uintList += i
    }
    ...
    y@for (i in ulongProgression step 2L step 1L) {
        ulongList += i
    }
    assertEquals(listOf(1uL, 2uL, 3uL, (ulongProgression).endInclusive, 5uL), ulongList)
...
File being compiled: /home/Anzhela.Sukhanova/fuzzer/JVMCompiler/projectTmp/stepToSmallerLastThenStepOne8.kt
...
Caused by: java.lang.IllegalStateException: Unresolved annotation type: [Error type: Unresolved type for UseExperimental] at /home/Anzhela.Sukhanova/fuzzer/JVMCompiler/projectTmp/stepToSmallerLastThenStepOne8.kt
