...
public  class Xoc <in T: Wrapper>  (vit: UByte?, val ayy: Wrapper, vararg wmd: Wrapper, var qfg: Wrapper?): Xoc<Xoc<Wrapper>> by ayy as Xoc<Wrapper>{
...
Combined output:
org.jetbrains.kotlin.util.KotlinFrontEndException: Front-end Internal error: Failed to analyze declaration Xoc
File being compiled: (2,1) in /home/Anzhela.Sukhanova/fuzzer/JVMCompiler/projectTmp/crossinlineLocalDeclaration.kt
...
Caused by: java.lang.AssertionError: Recursion detected on input: ayy under LockBasedStorageManager@459c6ab6 (TopDownAnalyzer for JVM)
	...
	at org.jetbrains.kotlin.resolve.scopes.SubstitutingScope.getContributedVariables(SubstitutingScope.kt:79)
