...
private open class Xbu <T>  (vararg ril: Elx, val gvg: Pair<ULong, Long?> = Pair<ULong, Long?>(79.toULong(), 36) as Xbu<Int>, gks: InlineNotNullPrimitive){
...
fun test(a: InlineNotNullPrimitive, b: InlineNotNullReference) {
    ...
    testNotNullPrimitive("covah" as T, null, InlineNotNullPrimitive(-30 as OnErrorAction), InlineNotNullPrimitive(-73 as HashMap<List<Byte>, Pair<InlineNotNullReference, ULong>>)) // 2 box
}

fun box(): String {
    val a = InlineNotNullPrimitive(10 as ShortArray)
