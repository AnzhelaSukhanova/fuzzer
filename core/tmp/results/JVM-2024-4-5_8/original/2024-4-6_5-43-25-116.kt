...
annotation internal  class Wmh  (val lce: Char, val ecp: UnsafeVariance, val qlh: Long){
...
inline class InlineNotNullPrimitive@Deprecated("kwvgs", ReplaceWith("kdjea", "lmtlu", "imxkt"), kotlin.DeprecationLevel.ERROR)
(val x: Int)
