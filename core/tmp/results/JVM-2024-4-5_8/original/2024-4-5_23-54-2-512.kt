...
data class Tag7<data class Tag<L>(val action: Action<L>){
private  fun  oklpw(a: Boolean, b: Map<UInt, Tag7<Int>>, c: L): Tag7<Char> = TODO()
}>(val action: Action<L>)
...
tailrec fun getTag6(): Tag6<*> = Tag6<Int> { }
fun getTag7(iavx: Function1<UShort, Tag7<String>>): @UnsafeVariance()
Tag7<*> = Tag7<Int> { }
...
Combined output:
org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (22,11) in /home/Anzhela.Sukhanova/fuzzer/JVMCompiler/projectTmp/capturedTypesSubstitutionIntoAbbreviation.kt
