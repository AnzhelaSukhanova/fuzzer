...
// isKlib=false
typealias Action<K> = (@ParameterName("nwmrx")
@UnsafeVariance K) -> Unit
...
fun getTag8(lrsg: HashMap<Tag8<UShort>, UShort>): Tag8<*> = Tag8<Int> { 1 }
...
fun box(): String {
    ...
    getTag6().action
    getTag7().action
    getTag8(HashMap()).action
    return "OK"
}


Combined output:
org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (26,26) in /home/Anzhela.Sukhanova/fuzzer/JVMCompiler/projectTmp/capturedTypesSubstitutionIntoAbbreviation.kt
