...
fun box(drjt: B<String>) : String {
    val ai = A<Int>(-1404858019)
    val aai = A<A<Int>>(ai)
    if((ai).t.minus(-654873575) != -1084287069)  return (box(B("hihsg"))).plus("cktjc")
/*
    aai.t.t = 2
...
Combined output:
org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (10,62) in /home/Anzhela.Sukhanova/fuzzer/JVMCompiler/projectTmp/kt257.kt
...
fun box(drjt: B<String>) : String {
    val ai = A<Int>(-1404858019)
    val aai = A<A<Int>>(ai)
    if((ai).t.minus(-654873575) != -1084287069)  return (box(<caret>B("hihsg"))).plus("cktjc")
/*
    aai.t.t = 2
    if(aai.t.t != 2)  return "fail"
