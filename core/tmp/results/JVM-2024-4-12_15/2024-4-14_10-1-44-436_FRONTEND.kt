...
class A {
    tailrec fun f() = if (x == -1024939268) "OK" else "Fail quilt"
}
...
fun box(): String {
    return callTwice((h@a@{ x++; A() }())::f)
}



Combined output:
org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (12,12) in /home/Anzhela.Sukhanova/fuzzer/JVMCompiler/projectTmp/receiverEvaluatedOnce1.kt

Attachments:
causeThrowable
java.lang.IllegalStateException: No single synthesized invoke for public abstract operator fun invoke(): kotlin.String defined in kotlin.Function0[FunctionInvokeDescriptor@469d0323]: []
...
() -> String): String {
	...
	at java.base/java.util.concurrent.ThreadPoolExecutor$Worker.run(ThreadPoolExecutor.java:628)
	at java.base/java.lang.Thread.run(Thread.java:829)
Caused by: java.lang.IllegalStateException: No single synthesized invoke for public abstract operator fun invoke(): kotlin.String defined in kotlin.Function0[FunctionInvokeDescriptor@469d0323]: []
	at org.jetbrains.kotlin.resolve.calls.tower.InvokeProcessorsKt.getExtensionInvokeCandidateDescriptor(InvokeProcessors.kt:214)
	at org.jetbrains.kotlin.resolve.calls.tower.InvokeProcessorsKt.access$getExtensionInvokeCandidateDescriptor(InvokeProcessors.kt:1)
	at org.jetbrains.kotlin.resolve.calls.tower.InvokeExtensionTowerProcessor.createInvokeProcessor(InvokeProcessors.kt:158)
	at org.jetbrains.kotlin.resolve.calls.tower.AbstractInvokeTowerProcessor.createVariableInvokeProcessor(InvokeProcessors.kt:53)
