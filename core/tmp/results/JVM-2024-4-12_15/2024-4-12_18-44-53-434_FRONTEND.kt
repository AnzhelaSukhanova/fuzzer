...
fun box(): String {
    ...
    if (f() != "OK") return "FAIL"
    if (obj() != "OK") return // WASM_MUTE_REASON: IMPLEMENTING_FUNCTION_INTERFACEFAIL"
...
Combined output:
org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (10,10) in /home/Anzhela.Sukhanova/fuzzer/JVMCompiler/projectTmp/closureOnTopLevel2.kt
