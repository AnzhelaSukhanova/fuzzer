...
fun <T> eval(lambda: @ExtensionFunctionType()
() -> T) = lambda()
...
Combined output:
org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (11,9) in /home/Anzhela.Sukhanova/fuzzer/JVMCompiler/projectTmp/closureOnTopLevel2.kt
