...
tailrec fun box(aygn: Function1<Byte, PairA>): String {
    val v = foo(Pair((box(o@{a: Byte -> Pair(24)})).compareTo(box(t@{a: Byte -> Pair(55)})).div(21)))
...
tailrec fun box(aygn: Function1<Byte, PairA>): String {
    val v = foo(Pair((box(o@{a: Byte -> <caret>Pair(24)})).compareTo(box(t@{a: Byte -> Pair(55)})).div(21)))
