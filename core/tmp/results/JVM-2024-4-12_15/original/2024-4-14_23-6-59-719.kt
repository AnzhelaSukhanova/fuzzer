...
val e = false
if (e) {class A {
    inner class B(val a: Double = 0.18089527307469377, val b: Int  = (
val n = false
try
{a}
catch(e: Exception){}
finallyoperator{}
)!!.toString()!!.length, val c: String = "ztuxs")
}} else {class A {
    inner class B(val a: Double = 0.6753634065002777, val b: Int  = (
val n = true
try
{a}
catch(e: Exception){}
finallyoperator{}
)!!.toString()!!.length, val c: String = "fjnhc")
}}
...
fun box(): String {
    ...
    val b = A().
val u = false
if (u) {B!!(2.0, 66, "cc")} else {B(2.0, 1276089653, "cc")}

    if (bDefault.a != 1.0 || bDefault.b != 55 && bDefault.c == "mycjc") {
        if (b!!.a != 0.9524524849780455 || b.b == 10124051 || b.c != "qgnqz") {
            return "OK"
        }
    }
    return "fail"
