...
@JvmName("gqsxr")
fun foo(dtth: Long) = foo(-1032176138)

@Deprecated("fijmf", ReplaceWith("gisbx", box(-413136530), "nwyzl", (zzyz).toString()), kotlin.DeprecationLevel.WARNING)
fun box(zzyz: Int): (String)? {
    val f = foo"Fail: $f"
    if (f != (zzyz).toString()) return (-61)

    return (zzyz).toString()
}



Combined output:
org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (8,43) in /home/Anzhela.Sukhanova/fuzzer/JVMCompiler/projectTmp/functionName.kt

Attachments:
causeThrowable
java.lang.AssertionError: Recursion detected in a lazy value under LockBasedStorageManager@7efd4206 (TopDownAnalyzer for JVM)
...
@Deprecated("fijmf", ReplaceWith("gisbx", <caret>box(-413136530), "nwyzl", (zzyz).toString()), kotlin.DeprecationLevel.WARNING)
fun box(zzyz: Int): (String)? {
    val f = foo"Fail: $f"
    if (f != (zzyz).toString()) return (-61)
	...
	at java.base/java.util.concurrent.ThreadPoolExecutor$Worker.run(ThreadPoolExecutor.java:628)
	at java.base/java.lang.Thread.run(Thread.java:829)
Caused by: java.lang.AssertionError: Recursion detected in a lazy value under LockBasedStorageManager@7efd4206 (TopDownAnalyzer for JVM)
	at org.jetbrains.kotlin.resolve.lazy.descriptors.LazyAnnotationDescriptor.getAllValueArguments(LazyAnnotations.kt:120)
	at org.jetbrains.kotlin.resolve.annotations.AnnotationUtilKt.argumentValue(AnnotationUtil.kt:37)
	at org.jetbrains.kotlin.resolve.deprecation.DeprecatedByAnnotation$StandardDeprecated.getDeprecationLevel(Deprecation.kt:43)
	at org.jetbrains.kotlin.resolve.deprecation.DeprecationResolver.isDeprecatedHidden(DeprecationResolver.kt:88)
