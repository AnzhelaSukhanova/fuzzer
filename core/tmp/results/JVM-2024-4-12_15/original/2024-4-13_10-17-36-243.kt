...
@Deprecated((box()).plus("wkaaa"), ReplaceWith((box()).stripLeading()?.plus("hfqfy")!!, box(), box(), box()), kotlin.DeprecationLevel.ERROR)
fun box() : String {
    val t = java.lang.String.copyValueOf(java.lang.String(box()).toCharArray())
    val i = java.lang.Integer.MAX_VALUE
    val j = java.lang.Integer.valueOf(15)
    val s = java.lang.String.valueOf(1234354301)
    
val o = (o).and(o)
when (o) {
 true -> {val l = java.util.Collections.emptyList<Int>()}
...
Attachments:
causeThrowable
java.lang.AssertionError: Recursion detected in a lazy value under LockBasedStorageManager@2ec7ffdb (TopDownAnalyzer for JVM)
...
@Deprecated((<caret>box()).plus("wkaaa"), ReplaceWith((box()).stripLeading()?.plus("hfqfy")!!, box(), box(), box()), kotlin.DeprecationLevel.ERROR)
fun box() : String {
    val t = java.lang.String.copyValueOf(java.lang.String(box()).toCharArray())
    val i = java.lang.Integer.MAX_VALUE
    val j = java.lang.Integer.valueOf(15)
...
when (o) {
 true -> {val l = java.util.Collections.emptyList<Int>()}
	...
	at java.base/java.util.concurrent.ThreadPoolExecutor$Worker.run(ThreadPoolExecutor.java:628)
	at java.base/java.lang.Thread.run(Thread.java:829)
Caused by: java.lang.AssertionError: Recursion detected in a lazy value under LockBasedStorageManager@2ec7ffdb (TopDownAnalyzer for JVM)
	at org.jetbrains.kotlin.resolve.lazy.descriptors.LazyAnnotationDescriptor.getAllValueArguments(LazyAnnotations.kt:120)
	at org.jetbrains.kotlin.resolve.annotations.AnnotationUtilKt.argumentValue(AnnotationUtil.kt:37)
	at org.jetbrains.kotlin.resolve.deprecation.DeprecatedByAnnotation$StandardDeprecated.getDeprecationLevel(Deprecation.kt:43)
	at org.jetbrains.kotlin.resolve.deprecation.DeprecationResolver.isDeprecatedHidden(DeprecationResolver.kt:88)
