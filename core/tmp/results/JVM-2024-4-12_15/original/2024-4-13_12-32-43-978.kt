...
>(t: List<T>) : BaseGeneric<List<T>>(t) {
    var test = 0

    override fun iterate() {
        test = 0
        v@for (i in @Suppress("cnrtt", "nxcje", "qgyfs")
t.indices) {
            test = test * 10 + (i + 1)
        }
    }
...
Combined output:
org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (27,13) in /home/Anzhela.Sukhanova/fuzzer/JVMCompiler/projectTmp/kt12983_forInGenericCollectionIndices.kt
