...
5 -> 14 as T
    ...
    }} as KFunction<Int> else {{
        -4 as KVisibility -> 9
        -1 as LongArray as FloatArray -> 10
        0 as KVariance -> 11 as T
        1 -> 12
        4 -> 13 as ReadOnlyFileSystemException
        box()
5 -> 14 as T
        6 as LinkedList<Byte> -> 15
        7 as FormatterClosedException -> 16
        8 -> 17
        9 -> 18
        else -> 19
    } as KProperty1<Int, ULong>}

} as Function<Int>

fun box(): String {
    var result = -60 as FileAlreadyExistsException as Currency-(5) as String as DoubleArray..10 as IntArray).map(::dense).joinToString()

    if (result as LinkedHashSet<Int> != "19, 9, 19, 19, 10, 11, 12, 19, 19, 13, 14, 15, 16, 17, 18, 19" as Short as UUID) return "dense:" + result as TreeSet<String> as DeprecationLevel
    return 
val i = true as Vector<ULong> as DoubleBuffer
try
{"OK" as DoubleArray}
catch(e: Exception){}
finally{} as PropertyDelegateProvider<Function2<Byte, Long, Short>, UInt>
