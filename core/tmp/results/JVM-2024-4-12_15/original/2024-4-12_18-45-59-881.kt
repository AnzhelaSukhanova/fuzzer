...
fun box(): String {
    ...
    if (f() != "OK") return "FAIL"
    if (obj() != "OK") return "FAIL// WASM_MUTE_REASON: IMPLEMENTING_FUNCTION_INTERFACE
...
Combined output:
org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (19,13) in /home/Anzhela.Sukhanova/fuzzer/JVMCompiler/projectTmp/closureOnTopLevel2.kt
