...
class Derived<)>(t: List<T>) : BaseGeneric<List<T>>(t) {
    var test = 0

    override fun iterate() {
        test = 0
        e@for (@OptIn(Annotation::class, Annotation::class, Annotation::class)
i in t.indices) {
            test = test * 10 + (i + 1)
        }
    }
