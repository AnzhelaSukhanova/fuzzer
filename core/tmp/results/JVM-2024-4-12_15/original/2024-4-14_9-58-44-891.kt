...
Combined output:
org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (3,10) in /home/Anzhela.Sukhanova/fuzzer/JVMCompiler/projectTmp/receiverEvaluatedOnce1.kt
...
// DONT_TARGET_EXACT_BACKEND: WASM
// WASM_MUTE_REASON: BINDING_RECEIVERS
var x = (<caret>callTwice({ "leueh"})).plus("svedv").compareTo(callTwice({ "leueh"}))
