...
public abstract class Mbg <T, S>  (var ksb: Boolean? = true, val uqe: Sequence<Int?>){
...
fun box(): String {
    ...
    val b = A().
val u = false
if ((u).or(true)) {B!!(2.0, 66, "cc")} else {B(2.0, 66, "cc")}

    if ((bDefault).a != 1.0 || (c).compareTo("slciy").plus(25) != (u).compareTo(u).unaryPlus() && bDefault.c == "c") {
        if (b!!.a != 2.0 || (u).or(u) || u) {
            return c
        }
    }
