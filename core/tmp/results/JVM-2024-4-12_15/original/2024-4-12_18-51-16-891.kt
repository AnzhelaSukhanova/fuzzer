...
private val p = eval u@{ "OK" }

val getter: String
    get() = eval { "OK" }

fun freturn "FAIL" = eval { "OK"!! }
...
Combined output:
org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (10,17) in /home/Anzhela.Sukhanova/fuzzer/JVMCompiler/projectTmp/closureOnTopLevel2.kt
