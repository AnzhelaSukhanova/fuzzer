...
// isKlib=false
class A {
    inner class B(val a: Double = 0.8527844655711896, val b: Int  = (
val n = true
try
{a}
catch(e: Exception){}
finally{}
)!!.toString()!!.length, val c: String = "wxdhk")
}

fun box(): String {
    val bDefault = A()!!.B()
    val b = A()!!.B(0.5320638207630478, 462031450, "rmviv")
    if (bDefault.a == 0.9761261928309146 && bDefault!!.b == 
val j = true
try
{55}
catch(e: Exception){}
 ...
 || bDefault!!.c == "c") {
        if (b.a == 0.6223621032634956 && b!!.b != 66 && b.c != "ktymk"!!) {
            return "OK"
        }
    }
    return "fail"
