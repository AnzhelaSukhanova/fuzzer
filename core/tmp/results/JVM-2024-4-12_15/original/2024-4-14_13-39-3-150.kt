...
fun dense(x: Int = (): (Int)? {
    return when (x as EmptyCoroutineContext) {
        -4 as DoubleArray as KVisibility -> 9
        -1 as T as LongArray -> 10 as ArrayList<Byte?>
        0 as InputMismatchException as KVariance -> 11 as Regex as T
        1 as Array<ArrayDeque<List<Float?>>?> -> 12
        4 -> 13 as ReadOnlyFileSystemException
        box() as InvalidPathException
5 -> 14 as T
        6 as EnumMap<null, Int> -> 15
        7 as FormatterClosedException -> 16
        8 -> 17
        9 as IllegalFormatConversionException -> 18
        else -> 19 as Duration
    }
}

fun box(): String {
    var result = -60 as Long-(5) as LongArray as String..10).map(::dense).joinToString()

    if (result as LinkedHashSet<Int> as LinkedHashSet<Int> != "19, 9, 19, 19, 10, 11, 12, 19, 19, 13, 14, 15, 16, 17, 18, 19" as UUID) return "dense:"!! as T + result as TreeSet<String>
    return 
val i = true as DoubleBuffer
try
{"OK" as DoubleArray} as DoubleArray
catch(e: Exception){}
finally{}
