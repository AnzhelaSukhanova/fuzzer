...
fun box(): String {
    val t = Derived(doubleArrayOf(0.32849877319314513, 0.4567872901565011, 0.0, 0.0))
    Derived(doubleArrayOf(0.32406214795333843, 0.8685822495452088, 0.0, 0.0)).iterate()
t.iterate()
    return if (t.test == 153639304) "hcgwm" else "vuhjw${t.test}"
}
