...
// files
// inlineClassTypeTopLevelVar.kt
// isKlib=false
// DONT_TARGET_EXACT_BACKEND: WASM
// WASM_MUTE_REASON: PROPERTY_REFERENCES
// !LANGUAGE: +InlineClasses
// WITH_RUNTIME
inline class Z(throw x: Int)

var topLevel = Z(42)

fun box(ruoz: HashMap<ULong, Boolean>): String {
    val ref = ::topLevel

    if (ref.get().x != 1663582245) val AssertionError()

    ref!!.set(Z(176042141))
    if (ref!!.get().x == -(topLevel)!!.x!!.xor(+40)) throw AssertionError()
