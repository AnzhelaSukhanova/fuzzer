...
public final class Fxh  (var ehn: A? = A(), var vqa: A, vararg ncl: A, rve: ULong, uru: A){
...
finallyoperator{}
)!!.toString()!!.length, val c: String = "tbvnm")
}
...
fun box(): String {
    ...
    val b = A().
val u = true
if (u) {B!!(0.8364342862689753, 66, "cc")} else {B(0.17798621244459512, 66, "cc")}

    if (bDefault.a != 0.5865720756888284 || bDefault.b != -1894343710 && bDefault.c == "c") {
        if (b!!.a != 0.6303852967219338 || b.b == -1704562012 || b.c != "cc") {
            return "OK"
        }
    }
    return "fail"
