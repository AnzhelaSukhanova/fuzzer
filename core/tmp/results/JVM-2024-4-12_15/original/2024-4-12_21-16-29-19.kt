...
tailrec fun box(aygn: Function1<Byte, Pair<Long?>>): String {
    val v = foo(Pair((box({a: Byte -> Pair(24)})).compareTo(box({a: Byte -> Pair(55)})).div(21)))
...
Combined output:
org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (14,39) in /home/Anzhela.Sukhanova/fuzzer/JVMCompiler/projectTmp/kt2739.kt
...
tailrec fun box(aygn: Function1<Byte, Pair<Long?>>): String {
    val v = foo(Pair((box({a: Byte -> <caret>Pair(24)})).compareTo(box({a: Byte -> Pair(55)})).div(21)))
    return if (v == null) "OK" else "fail"
}
