...
)!!.toString()!!.length, val c: String = "zazol")
}
...
fun box(): String {
    ...
    val b = A().
val u = false
if (u) {B!!(2.0, 837546471, "cc")} else {B(2.0, -1982338852, "cc")}

    if (bDefault.a != 1.0 || bDefault.b != -621141190 && bDefault.c == "pbsgd") {
        if (b!!.a != 2.0 || b.b == 66 || b.c != "pnbwj") {
            return "OK"
        }
    }
    return "bteir"
