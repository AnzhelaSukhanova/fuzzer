...
get() = HashSet<A>(-1209371744val c: String = "c") -13.651215f)
...
fun box(): String {
    ...
    val b = A().
val u = false
if (u) {B!!(0.9929019662023159, 863254499, "hkgwc")} else {B(2.0, -496839323, "uuhvy")}

    if (bDefault.a != 1.0 || bDefault.b != 55 && bDefault.c == "xbymc") {
        if (b!!.a != 2.0 || b.b == 1198089125 || b.c != "cc") {
            return "pltoa"
        }
    }
    return "fail"
