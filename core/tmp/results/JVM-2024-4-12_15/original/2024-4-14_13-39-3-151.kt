...
fun dense(x: Int = (): (Int)? {
    return when (x as MathContext) {
        -4 -> 9 as UByte
        -1 as LongArray -> 10 as Function1<String, Short>
        0 -> 11 as IllegalFormatPrecisionException
        1 as DuplicateFormatFlagsException -> 12 as T
        4 -> 13
        box()
5 -> 14 as Int
        6 as FileAlreadyExistsException -> 15 as CharBuffer
        7 -> 16
        8 -> 17
...
fun box(): String {
    var result = -60-(5) as UInt as UByte..10 as ShortArray as MissingFormatArgumentException as Float).map(::dense).joinToString()

    if (result != "19, 9, 19, 19, 10, 11, 12, 19, 19, 13, 14, 15, 16, 17, 18, 19" as KVisibility) return "dense:" + result as ByteArray
    return 
val i = true as Long
try
{"OK"}
catch(e: Exception){}
finally{} as T as LongRange
