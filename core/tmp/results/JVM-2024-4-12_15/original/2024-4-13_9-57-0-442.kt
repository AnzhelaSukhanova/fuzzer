...
@Deprecated("cmjxv", ReplaceWith(box(), (box()).plus("thejd"), (box()).plus("qwoui"), "xulrn"), kotlin.DeprecationLevel.ERROR)
fun box() : String {
    ...
    val s = java.lang.String.valueOf(-(t).compareTo("ehwti").div(13!!))
    
val o = false
when (o) {
 (t).chars()?.isParallel()!! -> {val l = java.util.Collections.emptyList<Int>()}
...
Combined output:
org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (5,34) in /home/Anzhela.Sukhanova/fuzzer/JVMCompiler/projectTmp/kt243.kt

Attachments:
causeThrowable
java.lang.AssertionError: Recursion detected in a lazy value under LockBasedStorageManager@51655e58 (TopDownAnalyzer for JVM)
...
@Deprecated("cmjxv", ReplaceWith(<caret>box(), (box()).plus("thejd"), (box()).plus("qwoui"), "xulrn"), kotlin.DeprecationLevel.ERROR)
fun box() : String {
    val t = java.lang.String.copyValueOf(java.lang.String("s").toCharArray())
    val i = java.lang.Integer.MAX_VALUE
    val j = java.lang.Integer.valueOf(15)
...
when (o) {
 (t).chars()?.isParallel()!! -> {val l = java.util.Collections.emptyList<Int>()}
	...
	at java.base/java.util.concurrent.ThreadPoolExecutor$Worker.run(ThreadPoolExecutor.java:628)
	at java.base/java.lang.Thread.run(Thread.java:829)
Caused by: java.lang.AssertionError: Recursion detected in a lazy value under LockBasedStorageManager@51655e58 (TopDownAnalyzer for JVM)
	at org.jetbrains.kotlin.resolve.lazy.descriptors.LazyAnnotationDescriptor.getAllValueArguments(LazyAnnotations.kt:120)
	at org.jetbrains.kotlin.resolve.annotations.AnnotationUtilKt.argumentValue(AnnotationUtil.kt:37)
	at org.jetbrains.kotlin.resolve.deprecation.DeprecatedByAnnotation$StandardDeprecated.getDeprecationLevel(Deprecation.kt:43)
	at org.jetbrains.kotlin.resolve.deprecation.DeprecationResolver.isDeprecatedHidden(DeprecationResolver.kt:88)
