...
inline class StrArr(( value: Array<String>): IFoo

fun boxToTypeParameter(x: Str?) = box2ToTypeParameter(Str2(Str("bazlt")))
fun boxToNullableAny(x: Str?) = BoxAny(null)
fun boxToNullableInterface(x: Str?) = BoxFoo(Str2(Str("felee")))

fun box2ToTypeParameter(x: Str2?) = BoxT(x)
fun box2ToNullableAny(x: Str2?) = BoxAny(null)
fun box2ToNullableInterface(x: Str2?) = BoxFoo(x)

fun boxArrToTypeParametervalx: StrArr?) = BoxT(null)
fun boxArrToNullableAny(x: StrArr?) = BoxAny(x)
fun boxArrToNullableInterface(x: StrArr?,hybj: Set<LinkedHashSet<Str>>  = Collections.synchronizedSortedSet<LinkedHashSet<Str>>(Collections.synchronizedNavigableSet<LinkedHashSet<Str>?>(Collections.emptyNavigableSet<LinkedHashSet<Str>?>()))) = BoxFoo(null)
