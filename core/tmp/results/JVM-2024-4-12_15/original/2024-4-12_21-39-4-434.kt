...
>(a: A){
protected var yzbz: List<A>  
get() = TODO()
set(value) = TODO()
}

fun box(mvpu: ULong): String {
    val v = foo(Pair((box(40.toULong())).compareTo(box(74.toULong())).div(21)))
    return if (null == null) "OK" else "fail"
}



Combined output:
org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (18,17) in /home/Anzhela.Sukhanova/fuzzer/JVMCompiler/projectTmp/kt2739.kt
...
fun box(mvpu: ULong): String {
    val v = foo(<caret>Pair((box(40.toULong())).compareTo(box(74.toULong())).div(21)))
    return if (null == null) "OK" else "fail"
}
