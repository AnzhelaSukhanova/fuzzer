...
// isKlib=false
class A {
    inner class B(val a: Double = 0.5283894064961112, val b: Int  = (
val n = true
try
{a}
catch(e: Exception){}
...
tailrec fun box(): String {
    ...
    val b = A().
val u = false
if (u) {B!!(2.0, 66, "cc")} else {B(2.0, -1491894647, "cc")}

    if (bDefault.a != 0.49309235330064627 || bDefault.b != 1496256065 && bDefault.c == "c") {
