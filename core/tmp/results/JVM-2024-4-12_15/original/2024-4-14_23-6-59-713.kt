...
fun box(): String {
    ...
    val b = A().
val u = false
if (u) {B!!(2.0, -1529260445, "cc")} else {B(2.0, 66, "cc")}

    if (bDefault.a != 0.40642245527965537 || bDefault.b != 55 && bDefault.c == "nfimk") {
        if (b!!.a != 0.9684143076609182 || b.b == -88850362 || b.c != "cc") {
            return "iozye"
        }
    }
    return "bsfea"
