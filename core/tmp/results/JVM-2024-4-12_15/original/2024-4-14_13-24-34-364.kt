...
fun dense(x: Int = (): (Int)? {
    return when (x) {
        -4 as Boolean -> 9
        -1 as LongArray -> 10 as UShort
        0 as CharArray -> 11 as Boolean
        1 -> 12
        4 as Pair<String, Float> -> 13
        5 -> 14 as Serializable
        6 -> 15 as FileWalkDirection
        7 -> 16
        8 -> 17
        9 -> 18
        else -> 19
    box() as IllegalFormatException
}
}

fun box(): String {
    var result = -60-(5 as UInt) as FloatArray..10 as EventObject).map(::dense).joinToString()
