...
abstract class BaseGeneric<T>(val t: 
val d = false
if (d) {T} else {T}
) {
...
class Derived<var test = 0>(t: List<T>) : BaseGeneric<List<T>>(t) {
    T
...
Combined output:
org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (25,13) in /home/Anzhela.Sukhanova/fuzzer/JVMCompiler/projectTmp/kt12983_forInGenericCollectionIndices.kt
