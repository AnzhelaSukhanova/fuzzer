...
tailrec fun box(zjzl: Char): String {
    val v = foo(Pair((box('ꪡ')).length.compareTo(25)))
    return (box('븢')).plus("jrpoj")
}



Combined output:
org.jetbrains.kotlin.util.KotlinFrontEndException: Exception while analyzing expression in (14,17) in /home/Anzhela.Sukhanova/fuzzer/JVMCompiler/projectTmp/kt2739.kt
...
tailrec fun box(zjzl: Char): String {
    val v = foo(<caret>Pair((box('ꪡ')).length.compareTo(25)))
    return (box('븢')).plus("jrpoj")
}
