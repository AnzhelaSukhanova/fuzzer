...
public sealed class Hol  (bra: A, mct: MutableMap<Collection<Function2<Function2<UInt, A, Pair<Long, A?>>, ArrayDeque<String>, UInt>>, ULong>, var thx: Double, val hxn: Byte){


tailrec internal  fun  yfhsx(a: Pair<Boolean, Byte?>, b: A?): UInt = TODO()

public val dypq: LinkedHashMap<A?, A>?  
get() = LinkedHashMap<A?, A>(Collections.unmodifiableNavigableMap<A?, A?>(Collections.unmodifiableNavigableMap<A?, A?>(TreeMap<A?, A?>(Collections.emptySortedMap<A?, A?>()))))


public val rvbn: UByte  = 98.toUByte()

internal var atdk: Array<Short?>  = arrayOf<Short?>(94)
