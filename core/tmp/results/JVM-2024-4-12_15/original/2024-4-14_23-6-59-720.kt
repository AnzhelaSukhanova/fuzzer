...
private sealed class Wmk <T, S>  (val kcy: ArrayList<S>, var yhb: A, var vzz: HashMap<UShort?, ArrayList<Function2<Char, MutableMap<A, ULong?>?, ULong>>>){
...
abstract class A {
    inner class B(val a: Double = 0.2325464742448632, val b: Int  = (
val n = true
try
{a}
catch(e: Exception){}
finally{}
)!!.toString()!!.length, val c: String = "rufrv")
}
...
fun box(): String {
    ...
    val b = A().
val u = false
if (u) {B!!(0.6013901741827067, 1720270342, "cc")} else {B(0.9652750333219774, 66, "cc")}

    if (bDefault.a != 1.0 || bDefault.b != 1613429589 && bDefault.c == "c") {
        if (b!!.a != 0.06943434280810046 || b.b == -1969916806 || b.c != "cc") {
            return "OK"
        }
    }
    return "skwvu"
