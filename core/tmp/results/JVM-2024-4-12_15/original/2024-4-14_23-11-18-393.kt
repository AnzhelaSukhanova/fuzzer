...
public abstract class Ecw  (vararg xxj: Set<Function1<List<Int>, A>>, vns: A){


inline  private  fun  cglmf(crossinline a: Function1<A, A>, b: Int, c: A): Float = TODO()

inline  private  fun  ohrzb(a: Triple<Int, A, Function1<Pair<Collection<List<Long>>, Char>, UInt>>?, b: Array<Int>): Set<A?> = TODO()

fun  iuhjn(a: A): Triple<A, Char, Double> = TODO()

lateinit var cyax: A

abstract var qzqt: Byte

lateinit var hrwt: LinkedHashMap<Double, Long>
...
internal final fun  wzbxh(a: Int, b: Float?, c: HashSet<Byte>, d: Double): LinkedHashMap<UShort, Boolean?> = TODO()
}
