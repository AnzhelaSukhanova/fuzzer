...
fun dense(x: Int = (): (Int)? {
    return when (x) {
        ...
        -1 -> 10 as IdentityHashMap<ULong?, LinkedHashSet<Collection<ULong>>>
        0 as InvalidPropertiesFormatException -> 11
        1 -> 12
        4 -> 13
        5 as DoubleArray -> 14
        6 as LinkedHashMap<Short, String> -> 15
        7 -> 16
        8 -> 17 as Byte
        9 -> 18
        else -> 19
...
fun box(): String {
    var result = -60 as BooleanArray-(5 as Pair<UShort, Collection<Double>>) as IllegalFormatWidthException..10).map(::dense).joinToString()

    if (result as ServiceLoader<Function2<ULong?, Set<ArrayDeque<UByte?>>, String>> != "19, 9, 19, 19, 10, 11, 12, 19, 19, 13, 14, 15, 16, 17, 18, 19" as AccessMode) return "dense:" + result as MissingResourceException
