...
internal var yvxt: LinkedHashMap<UByte, HashSet<A>>  = LinkedHashMap<UByte, HashSet<A>>(1031210426, 0.8676078945312957)
get() = LinkedHashMap<UByte, HashSet<A>>(52, 0.7137529322042778)
private set
...
).toString().length, val c: String = "wsfuv")
}
...
().B()
    val b = A().B(0.9610195176699557, 1631551324, "cc")
    if (bDefault.a == 0.9136002165320934 && bDefault.b == -745689875 && bDefault.c == "c") {
        if (b.a == 0.6814521590839021 && b.b == 66 && b.c == "cc") {
            return "OK"
        }
    }
    return "fail"
